# 8.3.31 configure help info

```bash
`configure' configures PHP 8.3.31 to adapt to many kinds of systems.

Usage: src/8.3.31/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.31
- 时间：07 May 2026
- [下载地址](https://www.php.net/distributions/php-8.3.31.tar.gz)
