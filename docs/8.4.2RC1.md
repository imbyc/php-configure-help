# 8.4.2RC1 configure help info

```bash
'configure' configures PHP 8.4.2RC1 to adapt to many kinds of systems.

Usage: src/8.4.2RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.2RC1
- 时间：05 Dec 2024
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.2RC1.tar.gz)
- sha256：30302775ec969e1aa37586b2a74a7ed82e806be41a386e548919f3a5ac6498e5
- md5：
