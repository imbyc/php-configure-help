# 8.2.0beta3 configure help info

```bash
`configure' configures PHP 8.2.0beta3 to adapt to many kinds of systems.

Usage: src/8.2.0beta3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0beta3
- 时间：18 Aug 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.0beta3.tar.gz)
- sha256：4f38fff5361bb597bd36c9652a78fed7a2894bb91e6bf126cc7793bc65acadcc
- md5：
