# 7.4.22RC1 configure help info

```bash
`configure' configures PHP 7.4.22RC1 to adapt to many kinds of systems.

Usage: src/7.4.22RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.22RC1
- 时间：15 Jul 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.22RC1.tar.gz)
- sha256：163db0b6672f0a244546c6834858c42188bb479b0b14fbe7fa4b0950f0bba46b
- md5：
