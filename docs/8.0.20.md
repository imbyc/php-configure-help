# 8.0.20 configure help info

```bash
`configure' configures PHP 8.0.20 to adapt to many kinds of systems.

Usage: src/8.0.20/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.20
- 时间：09 Jun 2022
- [下载地址](https://www.php.net/distributions/php-8.0.20.tar.gz)
