# 8.2.0beta2 configure help info

```bash
`configure' configures PHP 8.2.0beta2 to adapt to many kinds of systems.

Usage: src/8.2.0beta2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0beta2
- 时间：04 Aug 2022
- [下载地址](https://downloads.php.net/~sergey/php-8.2.0beta2.tar.gz)
- sha256：a8ed49485b836e2d559fb37d76d968bc154c32e6693034b2312a8423d6a09e17
- md5：
