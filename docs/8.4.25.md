# 8.4.25 configure help info

```bash
'configure' configures PHP 8.4.25 to adapt to many kinds of systems.

Usage: src/8.4.25/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.25
- 时间：27 Aug 2026
- [下载地址](https://www.php.net/distributions/php-8.4.25.tar.gz)
