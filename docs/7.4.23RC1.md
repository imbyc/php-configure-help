# 7.4.23RC1 configure help info

```bash
`configure' configures PHP 7.4.23RC1 to adapt to many kinds of systems.

Usage: src/7.4.23RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.23RC1
- 时间：12 Aug 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.23RC1.tar.gz)
- sha256：2a7af0727073667d23e1766bfd881f6bbb3c60b7173346d45e6c79e65db2d984
- md5：
