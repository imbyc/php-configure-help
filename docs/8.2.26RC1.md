# 8.2.26RC1 configure help info

```bash
`configure' configures PHP 8.2.26RC1 to adapt to many kinds of systems.

Usage: src/8.2.26RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.26RC1
- 时间：07 Nov 2024
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.26RC1.tar.gz)
- sha256：ae64fcd2eb7103dae334a0130e2c5b8a9fc0d666d7dd1f0a0c1529f99a65a853
- md5：
