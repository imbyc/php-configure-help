# 8.1.10RC1 configure help info

```bash
`configure' configures PHP 8.1.10RC1 to adapt to many kinds of systems.

Usage: src/8.1.10RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.10RC1
- 时间：18 Aug 2022
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.10RC1.tar.gz)
- sha256：fbe8b25be812a33ffaf10abbeb12089a51350720a5069166212df2db75578a79
- md5：
