# 8.4.4RC2 configure help info

```bash
'configure' configures PHP 8.4.4RC2 to adapt to many kinds of systems.

Usage: src/8.4.4RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.4RC2
- 时间：30 Jan 2025
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.4RC2.tar.gz)
- sha256：cb69fc9a3cec67e98ea218a0e9d6d2e18c0addeee432418e4adc6ddb284069c1
- md5：
