# 8.2.19 configure help info

```bash
'configure' configures PHP 8.2.19 to adapt to many kinds of systems.

Usage: src/8.2.19/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.19
- 时间：09 May 2024
- [下载地址](https://www.php.net/distributions/php-8.2.19.tar.gz)
