# 8.0.11RC1 configure help info

```bash
`configure' configures PHP 8.0.11RC1 to adapt to many kinds of systems.

Usage: src/8.0.11RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.11RC1
- 时间：12 Aug 2021
- [下载地址](https://downloads.php.net/~pollita/php-8.0.11RC1.tar.gz)
- sha256：17c70798f2cd7f99824df62a75aa89476916f88a01c791c32a8baefb4af2dbc4
- md5：
