# 8.4.0alpha2 configure help info

```bash
'configure' configures PHP 8.4.0alpha2 to adapt to many kinds of systems.

Usage: src/8.4.0alpha2/configure [OPTION]... [VAR=VALUE]...
...
Extensions:
  ...
  --with-ftp-ssl          Explicitly enable SSL support in ext/ftp when not
                          building with ext/openssl. If ext/openssl is enabled
                          at the configure step, SSL is enabled implicitly.
  ...
  --with-mysqlnd-ssl      Explicitly enable SSL support in ext/mysqlnd when
                          not building with ext/openssl. If ext/openssl is
                          enabled at the configure step, SSL is enabled
                          implicitly.
...
- 版本：8.4.0alpha2
- 时间：18 Jul 2024
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.0alpha2.tar.gz)
- sha256：909047b2cbffef6fd517d56fc54c28704d4e8a996b27f874505a22f4eec3333c
- md5：
