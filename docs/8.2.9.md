# 8.2.9 configure help info

```bash
`configure' configures PHP 8.2.9 to adapt to many kinds of systems.

Usage: src/8.2.9/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.9
- 时间：03 Aug 2023
- [下载地址](https://www.php.net/distributions/php-8.2.9.tar.gz)
