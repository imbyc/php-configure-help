# 8.2.5 configure help info

```bash
`configure' configures PHP 8.2.5 to adapt to many kinds of systems.

Usage: src/8.2.5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.5
- 时间：13 Apr 2023
- [下载地址](https://www.php.net/distributions/php-8.2.5.tar.gz)
