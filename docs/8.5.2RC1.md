# 8.5.2RC1 configure help info

```bash
`configure' configures PHP 8.5.2RC1 to adapt to many kinds of systems.

Usage: src/8.5.2RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.2RC1
- 时间：01 Jan 2026
- [下载地址](https://downloads.php.net/~daniels/php-8.5.2RC1.tar.gz)
- sha256：12f39245d139c956af072b45c3adbf9bb8b35d23a03e401cd502a83ed00d4d39
- md5：
