# 8.5.0alpha1 configure help info

```bash
`configure' configures PHP 8.5.0alpha1 to adapt to many kinds of systems.

Usage: src/8.5.0alpha1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0alpha1
- 时间：03 Jul 2025
- [下载地址](https://downloads.php.net/~daniels/php-8.5.0alpha1.tar.gz)
- sha256：381587f9f9a2e6c710a307760872629c9446f88f1a646e6f3e757702be7478a8
- md5：
