# 8.1.4 configure help info

```bash
`configure' configures PHP 8.1.4 to adapt to many kinds of systems.

Usage: src/8.1.4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.4
- 时间：17 Mar 2022
- [下载地址](https://www.php.net/distributions/php-8.1.4.tar.gz)
