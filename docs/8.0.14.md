# 8.0.14 configure help info

```bash
`configure' configures PHP 8.0.14 to adapt to many kinds of systems.

Usage: src/8.0.14/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.14
- 时间：16 Dec 2021
- [下载地址](https://www.php.net/distributions/php-8.0.14.tar.gz)
