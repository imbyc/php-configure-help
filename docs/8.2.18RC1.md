# 8.2.18RC1 configure help info

```bash
`configure' configures PHP 8.2.18RC1 to adapt to many kinds of systems.

Usage: src/8.2.18RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.18RC1
- 时间：28 Mar 2024
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.18RC1.tar.gz)
- sha256：900f37e159bd17f50ff0bdbdedff91c07f2808cbff3e458806766d28e6f8149a
- md5：
