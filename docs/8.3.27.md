# 8.3.27 configure help info

```bash
`configure' configures PHP 8.3.27 to adapt to many kinds of systems.

Usage: src/8.3.27/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.27
- 时间：23 Oct 2025
- [下载地址](https://www.php.net/distributions/php-8.3.27.tar.gz)
