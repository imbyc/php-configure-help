# 8.3.24RC1 configure help info

```bash
'configure' configures PHP 8.3.24RC1 to adapt to many kinds of systems.

Usage: src/8.3.24RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.24RC1
- 时间：17 Jul 2025
- [下载地址](https://downloads.php.net/~jakub/php-8.3.24RC1.tar.gz)
- sha256：76599db84ad4034f0b318405a59170c61e463eecfdde0aeb9c6fd00a14360d06
- md5：
