# 8.0.7RC1 configure help info

```bash
`configure' configures PHP 8.0.7RC1 to adapt to many kinds of systems.

Usage: src/8.0.7RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.7RC1
- 时间：20 May 2021
- [下载地址](https://downloads.php.net/~pollita/php-8.0.7RC1.tar.gz)
- sha256：d93e1f26cce090119fe43645da9f2493c720ce85d6744965fda143a5e7cdd416
- md5：
