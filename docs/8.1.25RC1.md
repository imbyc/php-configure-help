# 8.1.25RC1 configure help info

```bash
`configure' configures PHP 8.1.25RC1 to adapt to many kinds of systems.

Usage: src/8.1.25RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.25RC1
- 时间：12 Oct 2023
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.25RC1.tar.gz)
- sha256：4fc3569f640169d7cfd103a6273f93fa535c5e350b49f754013165fc33b9375e
- md5：
