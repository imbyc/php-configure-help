# 8.1.9RC1 configure help info

```bash
`configure' configures PHP 8.1.9RC1 to adapt to many kinds of systems.

Usage: src/8.1.9RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.9RC1
- 时间：21 Jul 2022
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.9RC1.tar.gz)
- sha256：7245ee7c175bd2a5c7e6f92c03ad646f0e767322caf203c7c31c0a0f017d90f9
- md5：
