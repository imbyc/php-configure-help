# 8.2.16RC1 configure help info

```bash
`configure' configures PHP 8.2.16RC1 to adapt to many kinds of systems.

Usage: src/8.2.16RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.16RC1
- 时间：01 Feb 2024
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.16RC1.tar.gz)
- sha256：a461eef7cc89679f9fe7295782a402848f1a91596832c7736165f63e7d127156
- md5：
