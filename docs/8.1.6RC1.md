# 8.1.6RC1 configure help info

```bash
`configure' configures PHP 8.1.6RC1 to adapt to many kinds of systems.

Usage: src/8.1.6RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.6RC1
- 时间：28 Apr 2022
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.6RC1.tar.gz)
- sha256：acf3cc76073fe78840defdc74eb691c874837eefa9e33aa7d7a087b11f01c8aa
- md5：
