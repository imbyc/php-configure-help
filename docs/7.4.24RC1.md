# 7.4.24RC1 configure help info

```bash
`configure' configures PHP 7.4.24RC1 to adapt to many kinds of systems.

Usage: src/7.4.24RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.24RC1
- 时间：09 Sep 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.24RC1.tar.gz)
- sha256：9c17c2f1972a3daef29979a7cd93f6562df6d1a62dab9a09b733abf53441bac3
- md5：
