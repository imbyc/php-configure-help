# 8.2.27RC1 configure help info

```bash
'configure' configures PHP 8.2.27RC1 to adapt to many kinds of systems.

Usage: src/8.2.27RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.27RC1
- 时间：05 Dec 2024
- [下载地址](https://downloads.php.net/~sergey/php-8.2.27RC1.tar.gz)
- sha256：60631c37e3fa9a55228b5903eebbdd3ce349e33edd0ab1898ea118b770f4d3a8
- md5：
