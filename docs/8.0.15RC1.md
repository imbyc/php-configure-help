# 8.0.15RC1 configure help info

```bash
`configure' configures PHP 8.0.15RC1 to adapt to many kinds of systems.

Usage: src/8.0.15RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.15RC1
- 时间：06 Jan 2022
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.15RC1.tar.gz)
- sha256：4098fa321eaf486e0d21317357c101509c200e65f5c21c3e11987862db279abc
- md5：
