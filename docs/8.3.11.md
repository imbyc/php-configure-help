# 8.3.11 configure help info

```bash
`configure' configures PHP 8.3.11 to adapt to many kinds of systems.

Usage: src/8.3.11/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.11
- 时间：29 Aug 2024
- [下载地址](https://www.php.net/distributions/php-8.3.11.tar.gz)
- sha256：b93a69af83a1302543789408194bd1ae9829e116e784d578778200f20f1b72d40
- md5：
