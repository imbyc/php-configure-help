# 8.3.0RC4 configure help info

```bash
`configure' configures PHP 8.3.0RC4 to adapt to many kinds of systems.

Usage: src/8.3.0RC4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.0RC4
- 时间：12 Oct 2023
- [下载地址](https://downloads.php.net/~eric/php-8.3.0RC4.tar.gz)
- sha256：e8405f29a4193b8e1e57da1ba4ce6e3a20994415ba910eee41b44895d1756b98
- md5：
