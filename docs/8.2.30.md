# 8.2.30 configure help info

```bash
`configure' configures PHP 8.2.30 to adapt to many kinds of systems.

Usage: src/8.2.30/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.30
- 时间：18 Dec 2025
- [下载地址](https://www.php.net/distributions/php-8.2.30.tar.gz)
