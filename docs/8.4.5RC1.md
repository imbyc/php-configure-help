# 8.4.5RC1 configure help info

```bash
'configure' configures PHP 8.4.5RC1 to adapt to many kinds of systems.

Usage: src/8.4.5RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.5RC1
- 时间：27 Feb 2025
- [下载地址](https://downloads.php.net/~saki/php-8.4.5RC1.tar.gz)
- sha256：092fec45e23fd8375df209c3a1bde6de5432f4af8affdfedc6cd7c4bc670e2f4
- md5：
