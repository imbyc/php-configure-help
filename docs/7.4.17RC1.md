# 7.4.17RC1 configure help info

```bash
`configure' configures PHP 7.4.17RC1 to adapt to many kinds of systems.

Usage: src/7.4.17RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.17RC1
- 时间：18 Mar 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.17RC1.tar.gz)
- sha256：c048d0de47ec5e7a6b22b1eb4e7e732dc7f8a348df2e32c93f7e8010b7a421eb
- md5：
