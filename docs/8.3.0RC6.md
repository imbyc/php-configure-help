# 8.3.0RC6 configure help info

```bash
`configure' configures PHP 8.3.0RC6 to adapt to many kinds of systems.

Usage: src/8.3.0RC6/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.0RC6
- 时间：09 Nov 2023
- [下载地址](https://downloads.php.net/~eric/php-8.3.0RC6.tar.gz)
- sha256：83e838f91a0b6370caff3dacf0d80275234ace7f9892212732807a4c5e33c6ed
- md5：
