# 8.1.8 configure help info

```bash
`configure' configures PHP 8.1.8 to adapt to many kinds of systems.

Usage: src/8.1.8/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.8
- 时间：07 Jul 2022
- [下载地址](https://www.php.net/distributions/php-8.1.8.tar.gz)
