# 8.1.3RC1 configure help info

```bash
`configure' configures PHP 8.1.3RC1 to adapt to many kinds of systems.

Usage: src/8.1.3RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.3RC1
- 时间：03 Feb 2022
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.3RC1.tar.gz)
- sha256：0deac058c9269716c7a8c22b0f9615bbc3e2bb5dcb314379f118611c040895ad
- md5：
