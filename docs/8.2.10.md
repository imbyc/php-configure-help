# 8.2.10 configure help info

```bash
`configure' configures PHP 8.2.10 to adapt to many kinds of systems.

Usage: src/8.2.10/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.10
- 时间：31 Aug 2023
- [下载地址](https://www.php.net/distributions/php-8.2.10.tar.gz)
