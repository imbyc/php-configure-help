# 8.4.23RC1 configure help info

```bash
'configure' configures PHP 8.4.23RC1 to adapt to many kinds of systems.

Usage: src/8.4.23RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.23RC1
- 时间：18 Jun 2026
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.23RC1.tar.gz)
- sha256：ab863318f529ace5e1f96db1670e3ca537d10668fbe055ca76b7d9d098303137
- md5：
