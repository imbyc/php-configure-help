# 8.3.3RC1 configure help info

```bash
`configure' configures PHP 8.3.3RC1 to adapt to many kinds of systems.

Usage: src/8.3.3RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.3RC1
- 时间：01 Feb 2024
- [下载地址](https://downloads.php.net/~eric/php-8.3.3RC1.tar.gz)
- sha256：66f8d2cb47d7733d861f65e9bc6680f6025e18f00d260a4e5a87f4a6bc5261e8
- md5：
