# 8.0.10RC1 configure help info

```bash
`configure' configures PHP 8.0.10RC1 to adapt to many kinds of systems.

Usage: src/8.0.10RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.10RC1
- 时间：12 Aug 2021
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.10RC1.tar.gz)
- sha256：64e5b143cc1abfb6510a1a8cb4e8d1b8fabadbe0b941beeada0d4cb6112d48ef
- md5：
