# 8.1.34 configure help info

```bash
'configure' configures PHP 8.1.34 to adapt to many kinds of systems.

Usage: src/8.1.34/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.34
- 时间：18 Dec 2025
- [下载地址](https://www.php.net/distributions/php-8.1.34.tar.gz)
