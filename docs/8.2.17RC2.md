# 8.2.17RC2 configure help info

```bash
'configure' configures PHP 8.2.17RC2 to adapt to many kinds of systems.

Usage: src/8.2.17RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.17RC2
- 时间：29 Feb 2024
- [下载地址](https://downloads.php.net/~sergey/php-8.2.17RC2.tar.gz)
- sha256：fc878f53053b94b8b64f8e064bf424df1cfff1a9a24ff25fe68b85bbf12552f4
- md5：
