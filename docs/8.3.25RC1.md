# 8.3.25RC1 configure help info

```bash
`configure' configures PHP 8.3.25RC1 to adapt to many kinds of systems.

Usage: src/8.3.25RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.25RC1
- 时间：14 Aug 2025
- [下载地址](https://downloads.php.net/~eric/php-8.3.25RC1.tar.gz)
- sha256：3e65cacc2304e7ced1b3204097d0fc0b9cafaa67f786446305813473f6915df4
- md5：
