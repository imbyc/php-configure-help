# 8.0.15 configure help info

```bash
`configure' configures PHP 8.0.15 to adapt to many kinds of systems.

Usage: src/8.0.15/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.15
- 时间：20 Jan 2022
- [下载地址](https://www.php.net/distributions/php-8.0.15.tar.gz)
