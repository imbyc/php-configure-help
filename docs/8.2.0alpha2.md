# 8.2.0alpha2 configure help info

```bash
`configure' configures PHP 8.2.0alpha2 to adapt to many kinds of systems.

Usage: src/8.2.0alpha2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0alpha2
- 时间：23 Jun 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.0alpha2.tar.gz)
- sha256：92d8747a4380ae3e8020a1671a51173a051bbb3eb02af80962785dea342e5801
- md5：
