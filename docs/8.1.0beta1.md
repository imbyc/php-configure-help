# 8.1.0beta1 configure help info

```bash
`configure' configures PHP 8.1.0beta1 to adapt to many kinds of systems.

Usage: src/8.1.0beta1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0beta1
- 时间：22 Jul 2021
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.0beta1.tar.gz)
- sha256：97c039f059f0918658f9b5ebab5eca3af981afd50bdd078b56a38cd2ca408cc7
- md5：
