# 8.3.22 configure help info

```bash
'configure' configures PHP 8.3.22 to adapt to many kinds of systems.

Usage: src/8.3.22/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.22
- 时间：5 Jun 2025
- [下载地址](https://www.php.net/distributions/php-8.3.22.tar.gz)
