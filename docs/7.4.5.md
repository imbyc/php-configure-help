# 7.4.5 configure help info

```bash
`configure' configures PHP 7.4.5 to adapt to many kinds of systems.

Usage: src/7.4.5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.5
- 时间：16 Apr 2020
- [下载地址](https://www.php.net/distributions/php-7.4.5.tar.gz)
