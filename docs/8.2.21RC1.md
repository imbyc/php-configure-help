# 8.2.21RC1 configure help info

```bash
'configure' configures PHP 8.2.21RC1 to adapt to many kinds of systems.

Usage: src/8.2.21RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.21RC1
- 时间：20 Jun 2024
- [下载地址](https://downloads.php.net/~sergey/php-8.2.21RC1.tar.gz)
- sha256：ef38691bc9ce5b7b05a1a24dfbe9e6c3407350eb5185d85050f3b436ba165123
- md5：
