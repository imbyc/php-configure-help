# 8.5.6 configure help info

```bash
`configure' configures PHP 8.5.6 to adapt to many kinds of systems.

Usage: src/8.5.6/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.6
- 时间：07 May 2026
- [下载地址](https://www.php.net/distributions/php-8.5.6.tar.gz)
