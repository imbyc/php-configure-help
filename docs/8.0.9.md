# 8.0.9 configure help info

```bash
`configure' configures PHP 8.0.9 to adapt to many kinds of systems.

Usage: src/8.0.9/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.9
- 时间：29 Jul 2021
- [下载地址](https://www.php.net/distributions/php-8.0.9.tar.gz)
