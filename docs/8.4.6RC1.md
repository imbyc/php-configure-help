# 8.4.6RC1 configure help info

```bash
'configure' configures PHP 8.4.6RC1 to adapt to many kinds of systems.

Usage: src/8.4.6RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.6RC1
- 时间：27 Mar 2025
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.6RC1.tar.gz)
- sha256：77db6ac2615d1b0618f1f9d43ee9bf29e27e43426d52833b8107bf5ee8b53eb2
- md5：
