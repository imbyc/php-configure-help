# 8.4.0beta3 configure help info

```bash
'configure' configures PHP 8.4.0beta3 to adapt to many kinds of systems.

Usage: src/8.4.0beta3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0beta3
- 时间：15 Aug 2024
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.0beta3.tar.gz)
- sha256：a2466aca468a4dd1bde15dd604e80bb80a8d44982fbec0c1acaed52f06980240
- md5：
