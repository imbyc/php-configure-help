# 8.1.26RC1 configure help info

```bash
`configure' configures PHP 8.1.26RC1 to adapt to many kinds of systems.

Usage: src/8.1.26RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.26RC1
- 时间：09 Nov 2023
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.26RC1.tar.gz)
- sha256：1b7c8af2c41450e904c2375f84949a30f4fa91a9df1cdfe018a00ad28e4b6721
- md5：
