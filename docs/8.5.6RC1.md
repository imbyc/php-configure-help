# 8.5.6RC1 configure help info

```bash
`configure' configures PHP 8.5.6RC1 to adapt to many kinds of systems.

Usage: src/8.5.6RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.6RC1
- 时间：23 Apr 2026
- [下载地址](https://downloads.php.net/~daniels/php-8.5.6RC1.tar.gz)
- sha256：dc1cf05cd4533b81506074c208db1ce33b643ce30108392233cae21a5c841734
- md5：
