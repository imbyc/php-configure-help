# 8.2.2RC1 configure help info

```bash
`configure' configures PHP 8.2.2RC1 to adapt to many kinds of systems.

Usage: src/8.2.2RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.2RC1
- 时间：19 Jan 2023
- [下载地址](https://downloads.php.net/~sergey/php-8.2.2RC1.tar.gz)
- sha256：08ac202d4e208a89d6849f321ffd128111632b87ada80ac876c9b32a52cdd614
- md5：
