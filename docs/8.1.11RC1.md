# 8.1.11RC1 configure help info

```bash
`configure' configures PHP 8.1.11RC1 to adapt to many kinds of systems.

Usage: src/8.1.11RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.11RC1
- 时间：15 Sep 2022
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.11RC1.tar.gz)
- sha256：538faa9e8c9f1027f6de669fbce153779d15f39b09a61d952ea7767ea41b6451
- md5：
