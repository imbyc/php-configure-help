# 8.1.0RC2 configure help info

```bash
`configure' configures PHP 8.1.0RC2 to adapt to many kinds of systems.

Usage: src/8.1.0RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0RC2
- 时间：16 Sep 2021
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.0RC2.tar.gz)
- sha256：08d6b7e04f32884e6dffcfb696cc194ad5c48ce142fb7021007f8a4d6b421c42
- md5：
