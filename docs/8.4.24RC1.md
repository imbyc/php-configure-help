# 8.4.24RC1 configure help info

```bash
'configure' configures PHP 8.4.24RC1 to adapt to many kinds of systems.

Usage: src/8.4.24RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.24RC1
- 时间：16 July 2026
- [下载地址](https://downloads.php.net/~saki/php-8.4.24RC1.tar.gz)
- sha256：0cc5b8c97adbd854222695f3e45667d3b2dd3b9fa1d0f4c9cb0c965a0e291d48
- md5：
