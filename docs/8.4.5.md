# 8.4.5 configure help info

```bash
'configure' configures PHP 8.4.5 to adapt to many kinds of systems.

Usage: src/8.4.5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.5
- 时间：13 Mar 2025
- [下载地址](https://www.php.net/distributions/php-8.4.5.tar.gz)
