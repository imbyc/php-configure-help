# 8.6.0alpha3 configure help info

```bash
'configure' configures PHP 8.6.0alpha3 to adapt to many kinds of systems.

Usage: src/8.6.0alpha3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.6.0alpha3
- 时间：30 July 2026
- [下载地址](https://downloads.php.net/~mbeccati/php-8.6.0alpha3.tar.gz)
- sha256：e63ffdbae7ee90b43ce11b2ec16f62c6b623eec39c726060dba920af6088527b
- md5：
