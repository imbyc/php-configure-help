# 7.4.2 configure help info

```bash
`configure' configures PHP 7.4.2 to adapt to many kinds of systems.

Usage: src/7.4.2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.2
- 时间：23 Jan 2020
- [下载地址](https://www.php.net/distributions/php-7.4.2.tar.gz)
