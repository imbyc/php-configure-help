# 8.3.22RC1 configure help info

```bash
'configure' configures PHP 8.3.22RC1 to adapt to many kinds of systems.

Usage: src/8.3.22RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.22RC1
- 时间：22 May 2025
- [下载地址](https://downloads.php.net/~jakub/php-8.3.22RC1.tar.gz)
- sha256：0fa5c6abcd4196c5ad08f4883b4435db462e828ced42c76c132ad354bd29bd23
- md5：
