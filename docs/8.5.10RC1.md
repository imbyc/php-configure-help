# 8.5.10RC1 configure help info

```bash
`configure' configures PHP 8.5.10RC1 to adapt to many kinds of systems.

Usage: src/8.5.10RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.10RC1
- 时间：13 August 2026
- [下载地址](https://downloads.php.net/~daniels/php-8.5.10RC1.tar.gz)
- sha256：ef9a00660be937664e1a02c4bf8487d6addc3a8513a415fc30974a3e84932b39
- md5：
