# 8.0.9RC1 configure help info

```bash
`configure' configures PHP 8.0.9RC1 to adapt to many kinds of systems.

Usage: src/8.0.9RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.9RC1
- 时间：15 Jul 2021
- [下载地址](https://downloads.php.net/~pollita/php-8.0.9RC1.tar.gz)
- sha256：cbdc1dd2360886a664bb533790db53d88f71c6d8adb527135f007c8fae8dbe42
- md5：
