# 8.3.26RC1 configure help info

```bash
'configure' configures PHP 8.3.26RC1 to adapt to many kinds of systems.

Usage: src/8.3.26RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.26RC1
- 时间：11 Sep 2025
- [下载地址](https://downloads.php.net/~jakub/php-8.3.26RC1.tar.gz)
- sha256：6225da9473eeb04e8f0e30d10e0481999129d08e12b0467b2542f306b517e2c9
- md5：
