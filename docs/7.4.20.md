# 7.4.20 configure help info

```bash
`configure' configures PHP 7.4.20 to adapt to many kinds of systems.

Usage: src/7.4.20/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.20
- 时间：03 Jun 2021
- [下载地址](https://www.php.net/distributions/php-7.4.20.tar.gz)
