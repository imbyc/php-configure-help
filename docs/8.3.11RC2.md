# 8.3.11RC2 configure help info

```bash
`configure' configures PHP 8.3.11RC2 to adapt to many kinds of systems.

Usage: src/8.3.11RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.11RC2
- 时间：22 Aug 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.11RC2.tar.gz)
- sha256：db4ad66bc3bb2619ebfc9c68b80e6e8be0fc33ca027cfc5085e31d20e37d709b
- md5：
