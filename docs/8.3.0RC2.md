# 8.3.0RC2 configure help info

```bash
`configure' configures PHP 8.3.0RC2 to adapt to many kinds of systems.

Usage: src/8.3.0RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.0RC2
- 时间：14 Sep 2023
- [下载地址](https://downloads.php.net/~eric/php-8.3.0RC2.tar.gz)
- sha256：702f64e630e9b0f339740ef4cf730d84850c1aa68e0e6b194952eddf9bdc23ec
- md5：
