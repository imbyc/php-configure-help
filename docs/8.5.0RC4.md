# 8.5.0RC4 configure help info

```bash
'configure' configures PHP 8.5.0RC4 to adapt to many kinds of systems.

Usage: src/8.5.0RC4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0RC4
- 时间：06 Nov 2025
- [下载地址](https://downloads.php.net/~edorian/php-8.5.0RC4.tar.gz)
- sha256：eaeb71efaba8bfaacd9977cc2c2c24470cda974364afcac07d74f9861b065653
- md5：
