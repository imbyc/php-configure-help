# 7.4.8 configure help info

```bash
`configure' configures PHP 7.4.8 to adapt to many kinds of systems.

Usage: src/7.4.8/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.8
- 时间：09 Jul 2020
- [下载地址](https://www.php.net/distributions/php-7.4.8.tar.gz)
