# 8.4.18RC1 configure help info

```bash
'configure' configures PHP 8.4.18RC1 to adapt to many kinds of systems.

Usage: src/8.4.18RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.18RC1
- 时间：29 Jan 2026
- [下载地址](https://downloads.php.net/~saki/php-8.4.18RC1.tar.gz)
- sha256：b92a28c12d63354c57c2d5a7981f2881bee6804ffe39a9ca5865d9ec52d5fb0c
- md5：
