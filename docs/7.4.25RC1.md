# 7.4.25RC1 configure help info

```bash
`configure' configures PHP 7.4.25RC1 to adapt to many kinds of systems.

Usage: src/7.4.25RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.25RC1
- 时间：07 Oct 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.25RC1.tar.gz)
- sha256：1a5da35a58be0807039a7793616a8a3143040004e6833ea34ac4567af550c1f7
- md5：
