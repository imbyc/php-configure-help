# 8.5.3RC1 configure help info

```bash
'configure' configures PHP 8.5.3RC1 to adapt to many kinds of systems.

Usage: src/8.5.3RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.3RC1
- 时间：29 Jan 2026
- [下载地址](https://downloads.php.net/~edorian/php-8.5.3RC1.tar.gz)
- sha256：63ce96a80c466891fdb1d4841704c846bb71c2b10c1bdaeb0298332dd4863087
- md5：
