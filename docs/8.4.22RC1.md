# 8.4.22RC1 configure help info

```bash
'configure' configures PHP 8.4.22RC1 to adapt to many kinds of systems.

Usage: src/8.4.22RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.22RC1
- 时间：21 May 2026
- [下载地址](https://downloads.php.net/~saki/php-8.4.22RC1.tar.gz)
- sha256：34ad40683315db9cf76f2d8f79eb06f4363e76e76bc88f489a64c9512af38c43
- md5：
