# 8.3.4RC1 configure help info

```bash
`configure' configures PHP 8.3.4RC1 to adapt to many kinds of systems.

Usage: src/8.3.4RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.4RC1
- 时间：29 Feb 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.4RC1.tar.gz)
- sha256：05189cecdacdce87b106d0106aa22dda2f78ef02b5f1cf30f40724ec07f1a929
- md5：
