# 8.1.14 configure help info

```bash
`configure' configures PHP 8.1.14 to adapt to many kinds of systems.

Usage: src/8.1.14/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.14
- 时间：05 Jan 2023
- [下载地址](https://www.php.net/distributions/php-8.1.14.tar.gz)
