# 8.1.0RC4 configure help info

```bash
`configure' configures PHP 8.1.0RC4 to adapt to many kinds of systems.

Usage: src/8.1.0RC4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0RC4
- 时间：14 Oct 2021
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.0RC4.tar.gz)
- sha256：6e4e0bba242149ac467ed9624f0b34d482dc53bf85aff2790a7b695fe91459ea
- md5：
