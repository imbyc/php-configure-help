# 7.4.18 configure help info

```bash
`configure' configures PHP 7.4.18 to adapt to many kinds of systems.

Usage: src/7.4.18/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.18
- 时间：29 Apr 2021
- [下载地址](https://www.php.net/distributions/php-7.4.18.tar.gz)
