# 8.2.0RC1 configure help info

```bash
`configure' configures PHP 8.2.0RC1 to adapt to many kinds of systems.

Usage: src/8.2.0RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0RC1
- 时间：1 Sep 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.0RC1.tar.gz)
- sha256：487b20e853f9186182f8ae5f4fc9700f2c829a22b7598526cdbf0304d57906a3
- md5：
