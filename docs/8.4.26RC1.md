# 8.4.26RC1 configure help info

```bash
'configure' configures PHP 8.4.26RC1 to adapt to many kinds of systems.

Usage: src/8.4.26RC1/configure [OPTION]... [VAR=VALUE]...
...
- [下载地址](https://downloads.php.net/~saki/php-8.4.26RC1.tar.gz)
- sha256：48a559ba2cb17f21a4bbbf21624e616e5c7e3d4ce92eba7ffbc260c3b52bba5f
- md5：
