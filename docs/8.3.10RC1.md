# 8.3.10RC1 configure help info

```bash
`configure' configures PHP 8.3.10RC1 to adapt to many kinds of systems.

Usage: src/8.3.10RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.10RC1
- 时间：18 Jul 2024
- [下载地址](https://downloads.php.net/~eric/php-8.3.10RC1.tar.gz)
- sha256：f5f40fb3e4253a1055606a24801e1a98600e30aa88d8ee0fa1cb0eb3f608cf8b
- md5：
