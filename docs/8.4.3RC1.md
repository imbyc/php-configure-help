# 8.4.3RC1 configure help info

```bash
'configure' configures PHP 8.4.3RC1 to adapt to many kinds of systems.

Usage: src/8.4.3RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.3RC1
- 时间：02 Jan 2025
- [下载地址](https://downloads.php.net/~saki/php-8.4.3RC1.tar.gz)
- sha256：6070b700ce4058113db0aa0eb693afada8fc79fa1ce5713b081dde4778d3cec9
- md5：
