# 8.2.32 configure help info

```bash
'configure' configures PHP 8.2.32 to adapt to many kinds of systems.

Usage: src/8.2.32/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.32
- 时间：02 Jul 2026
- [下载地址](https://www.php.net/distributions/php-8.2.32.tar.gz)
- sha256：56c9d6911da0d337e2c1681f6a767ac0571821e1f16c8fdf9c248bf317d99b94
- md5：
