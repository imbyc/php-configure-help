# 8.4.11RC1 configure help info

```bash
'configure' configures PHP 8.4.11RC1 to adapt to many kinds of systems.

Usage: src/8.4.11RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.11RC1
- 时间：17 Jul 2025
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.11RC1.tar.gz)
- sha256：c19c5daa94c8171c5ceb04214212cc7cc5c284804de0f60e2a78d3aec5e65900
- md5：
