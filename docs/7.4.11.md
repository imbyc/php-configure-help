# 7.4.11 configure help info

```bash
`configure' configures PHP 7.4.11 to adapt to many kinds of systems.

Usage: src/7.4.11/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.11
- 时间：01 Oct 2020
- [下载地址](https://www.php.net/distributions/php-7.4.11.tar.gz)
