# 8.2.22RC1 configure help info

```bash
`configure' configures PHP 8.2.22RC1 to adapt to many kinds of systems.

Usage: src/8.2.22RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.22RC1
- 时间：18 Jul 2024
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.22RC1.tar.gz)
- sha256：d04c2589b538837a215c6d4db0b90538398df2f59bb0fb28e114ad2b87f04edd
- md5：
