# 8.5.7RC1 configure help info

```bash
'configure' configures PHP 8.5.7RC1 to adapt to many kinds of systems.

Usage: src/8.5.7RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.7RC1
- 时间：22 May 2026
- [下载地址](https://downloads.php.net/~edorian/php-8.5.7RC1.tar.gz)
- sha256：c0f66b8a8a653b2b07e21249f9bca70fdcf98cbdd1c7b5d5df2386ef667a326b
- md5：
