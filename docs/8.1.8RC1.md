# 8.1.8RC1 configure help info

```bash
`configure' configures PHP 8.1.8RC1 to adapt to many kinds of systems.

Usage: src/8.1.8RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.8RC1
- 时间：23 Jun 2022
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.8RC1.tar.gz)
- sha256：3a2a22fadee88bfc3ffd389af8875607d3cf3d22b62d02cc0747edec36aadfa0
- md5：
