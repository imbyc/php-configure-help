# 8.3.16RC1 configure help info

```bash
`configure' configures PHP 8.3.16RC1 to adapt to many kinds of systems.

Usage: src/8.3.16RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.16RC1
- 时间：02 Jan 2025
- [下载地址](https://downloads.php.net/~eric/php-8.3.16RC1.tar.gz)
- sha256：c430ff276ffde65e6dea8fd91baf76984a21087211413f32c866e0fda50ddb1d
- md5：
