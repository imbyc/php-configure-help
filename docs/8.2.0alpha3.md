# 8.2.0alpha3 configure help info

```bash
`configure' configures PHP 8.2.0alpha3 to adapt to many kinds of systems.

Usage: src/8.2.0alpha3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0alpha3
- 时间：07 Jul 2022
- [下载地址](https://downloads.php.net/~sergey/php-8.2.0alpha3.tar.gz)
- sha256：a5606a5d3fd358b70d5e43059d62f93aa66ab954b9d40baf98a82497d541d4c7
- md5：
