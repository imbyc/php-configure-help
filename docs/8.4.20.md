# 8.4.20 configure help info

```bash
'configure' configures PHP 8.4.20 to adapt to many kinds of systems.

Usage: src/8.4.20/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.20
- 时间：09 Apr 2026
- [下载地址](https://www.php.net/distributions/php-8.4.20.tar.gz)
