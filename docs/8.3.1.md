# 8.3.1 configure help info

```bash
`configure' configures PHP 8.3.1 to adapt to many kinds of systems.

Usage: src/8.3.1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.1
- 时间：21 Dec 2023
- [下载地址](https://www.php.net/distributions/php-8.3.1.tar.gz)
