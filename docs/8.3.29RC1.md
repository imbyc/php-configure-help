# 8.3.29RC1 configure help info

```bash
`configure' configures PHP 8.3.29RC1 to adapt to many kinds of systems.

Usage: src/8.3.29RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.29RC1
- 时间：04 Dec 2025
- [下载地址](https://downloads.php.net/~eric/php-8.3.29RC1.tar.gz)
- sha256：c74b7e27b06ec12e8d1e9e04baac084bd5ff1aff41cc640ab431a7a51eac8914
- md5：
