# 8.4.0RC2 configure help info

```bash
'configure' configures PHP 8.4.0RC2 to adapt to many kinds of systems.

Usage: src/8.4.0RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0RC2
- 时间：10 Oct 2024
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.0RC2.tar.gz)
- sha256：351ca0e3dfbb4fef182311984e4161d20ab7df85f383b93b6c60938d08e613bf
- md5：
