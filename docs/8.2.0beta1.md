# 8.2.0beta1 configure help info

```bash
`configure' configures PHP 8.2.0beta1 to adapt to many kinds of systems.

Usage: src/8.2.0beta1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0beta1
- 时间：21 Jul 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.0beta1.tar.gz)
- sha256：0eea12122debf8e291cec2d82059a29e61ad1a145458d0ae82d7cd11e10277c1
- md5：
