# 8.0.23RC1 configure help info

```bash
`configure' configures PHP 8.0.23RC1 to adapt to many kinds of systems.

Usage: src/8.0.23RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.23RC1
- 时间：18 Aug 2022
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.23RC1.tar.gz)
- sha256：855f295e3dcd17e36d2100297697b38ca190e0da9fb837ff2cd060bb136e15ea
- md5：
