# 8.0.25RC1 configure help info

```bash
`configure' configures PHP 8.0.25RC1 to adapt to many kinds of systems.

Usage: src/8.0.25RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.25RC1
- 时间：13 Oct 2022
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.25RC1.tar.gz)
- sha256：b8503356d15ddbecc60f5875edf5f31706d9679f37c0a3f63191192955203b02
- md5：
