# 8.3.0RC3 configure help info

```bash
'configure' configures PHP 8.3.0RC3 to adapt to many kinds of systems.

Usage: src/8.3.0RC3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.0RC3
- 时间：28 Sep 2023
- [下载地址](https://downloads.php.net/~jakub/php-8.3.0RC3.tar.gz)
- sha256：5885965b3e315d62fdc151735fe579b1e2301a4ccf56b3fa18f96c34a3b898c8
- md5：
