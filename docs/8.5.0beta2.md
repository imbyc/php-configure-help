# 8.5.0beta2 configure help info

```bash
`configure' configures PHP 8.5.0beta2 to adapt to many kinds of systems.

Usage: src/8.5.0beta2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0beta2
- 时间：28 Aug 2025
- [下载地址](https://downloads.php.net/~daniels/php-8.5.0beta2.tar.gz)
- sha256：237833015ab63d5441fb781bc9848ae9bac4a7c3bdb1b6157139c41c1ea98b44
- md5：
