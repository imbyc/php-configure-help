# 8.3.19 configure help info

```bash
`configure' configures PHP 8.3.19 to adapt to many kinds of systems.

Usage: src/8.3.19/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.19
- 时间：13 Mar 2025
- [下载地址](https://www.php.net/distributions/php-8.3.19.tar.gz)
