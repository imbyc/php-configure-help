# 8.5.8RC1 configure help info

```bash
`configure' configures PHP 8.5.8RC1 to adapt to many kinds of systems.

Usage: src/8.5.8RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.8RC1
- 时间：18 June 2026
- [下载地址](https://downloads.php.net/~daniels/php-8.5.8RC1.tar.gz)
- sha256：57f93d2e0d76a26ac955e30cfab81dd910fc48e8bf78b3a15ff67df63a92ac72
- md5：
