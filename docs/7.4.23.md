# 7.4.23 configure help info

```bash
`configure' configures PHP 7.4.23 to adapt to many kinds of systems.

Usage: src/7.4.23/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.23
- 时间：26 Aug 2021
- [下载地址](https://www.php.net/distributions/php-7.4.23.tar.gz)
