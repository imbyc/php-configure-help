# 8.2.24RC1 configure help info

```bash
`configure' configures PHP 8.2.24RC1 to adapt to many kinds of systems.

Usage: src/8.2.24RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.24RC1
- 时间：12 Sep 2024
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.24RC1.tar.gz)
- sha256：901a0d3737aa5436bcc4dad670d3d5a68237469e54ccd3e0f6f813e06da695ee
- md5：
