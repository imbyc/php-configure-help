# 8.3.0RC1 configure help info

```bash
'configure' configures PHP 8.3.0RC1 to adapt to many kinds of systems.

Usage: src/8.3.0RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.0RC1
- 时间：31 Aug 2023
- [下载地址](https://downloads.php.net/~jakub/php-8.3.0RC1.tar.gz)
- sha256：dcdf1d6a91758a7eabc4c701cbd5a716cb782dea7fced85283ebc5f4fe099857
- md5：
