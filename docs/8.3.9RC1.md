# 8.3.9RC1 configure help info

```bash
`configure' configures PHP 8.3.9RC1 to adapt to many kinds of systems.

Usage: src/8.3.9RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.9RC1
- 时间：20 Jun 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.9RC1.tar.gz)
- sha256：1f257f8ee17b9df2528682512126ebd15291113525a170fc53bfa6347160ac71
- md5：
