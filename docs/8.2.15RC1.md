# 8.2.15RC1 configure help info

```bash
`configure' configures PHP 8.2.15RC1 to adapt to many kinds of systems.

Usage: src/8.2.15RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.15RC1
- 时间：04 Jan 2024
- [下载地址](https://downloads.php.net/~sergey/php-8.2.15RC1.tar.gz)
- sha256：1712d0f950b1d81a77dbabffdf0f6557e8733b689a9fbdb64dffdd6a5d3e943e
- md5：
