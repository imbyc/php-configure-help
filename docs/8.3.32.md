# 8.3.32 configure help info

```bash
'configure' configures PHP 8.3.32 to adapt to many kinds of systems.

Usage: src/8.3.32/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.32
- 时间：02 Jul 2026
- [下载地址](https://www.php.net/distributions/php-8.3.32.tar.gz)
