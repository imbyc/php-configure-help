# 7.4.27 configure help info

```bash
`configure' configures PHP 7.4.27 to adapt to many kinds of systems.

Usage: src/7.4.27/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.27
- 时间：16 Dec 2021
- [下载地址](https://www.php.net/distributions/php-7.4.27.tar.gz)
