# 8.4.14RC1 configure help info

```bash
'configure' configures PHP 8.4.14RC1 to adapt to many kinds of systems.

Usage: src/8.4.14RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.14RC1
- 时间：09 Oct 2025
- [下载地址](https://downloads.php.net/~saki/php-8.4.14RC1.tar.gz)
- sha256：5c41a7ac2bb5a8c2db9b13863a554e5f3b6cb1b6377be4b6d22599e0cb129c9e
- md5：
