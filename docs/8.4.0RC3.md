# 8.4.0RC3 configure help info

```bash
'configure' configures PHP 8.4.0RC3 to adapt to many kinds of systems.

Usage: src/8.4.0RC3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0RC3
- 时间：24 Oct 2024
- [下载地址](https://downloads.php.net/~saki/php-8.4.0RC3.tar.gz)
- sha256：1937d125c9bb42bc4d8dcd3b8bb25d377814aea50be492bbc64b3554b73af371
- md5：
