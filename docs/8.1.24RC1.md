# 8.1.24RC1 configure help info

```bash
`configure' configures PHP 8.1.24RC1 to adapt to many kinds of systems.

Usage: src/8.1.24RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.24RC1
- 时间：14 Sep 2023
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.24RC1.tar.gz)
- sha256：d0cbab016c791458171ca07a1b3846a7f47474823ee9469ea0f0a80239a64afd
- md5：
