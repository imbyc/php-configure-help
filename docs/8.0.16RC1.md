# 8.0.16RC1 configure help info

```bash
`configure' configures PHP 8.0.16RC1 to adapt to many kinds of systems.

Usage: src/8.0.16RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.16RC1
- 时间：03 Feb 2022
- [下载地址](https://downloads.php.net/~pollita/php-8.0.16RC1.tar.gz)
- sha256：b54f418f4c28e27b4c41b3f490c945c79266c2fd014060b59625c2acd4869a59
- md5：
