# 8.1.18 configure help info

```bash
`configure' configures PHP 8.1.18 to adapt to many kinds of systems.

Usage: src/8.1.18/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.18
- 时间：13 Apr 2023
- [下载地址](https://www.php.net/distributions/php-8.1.18.tar.gz)
