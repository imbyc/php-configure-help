# 8.1.27RC1 configure help info

```bash
`configure' configures PHP 8.1.27RC1 to adapt to many kinds of systems.

Usage: src/8.1.27RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.27RC1
- 时间：07 Nov 2023
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.27RC1.tar.gz)
- sha256：402bd10ba9362809c3d9569c4eddcc9ac01aa3ef582bc80839fcd7c235dc6566
- md5：
