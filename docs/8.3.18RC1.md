# 8.3.18RC1 configure help info

```bash
`configure' configures PHP 8.3.18RC1 to adapt to many kinds of systems.

Usage: src/8.3.18RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.18RC1
- 时间：27 Feb 2025
- [下载地址](https://downloads.php.net/~eric/php-8.3.18RC1.tar.gz)
- sha256：0c9e27fd409fc958eb490aee1fd5c6d32d4b6199a5aecb89eb2590ba3351cac2
- md5：
