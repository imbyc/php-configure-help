# 8.4.20RC1 configure help info

```bash
'configure' configures PHP 8.4.20RC1 to adapt to many kinds of systems.

Usage: src/8.4.20RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.20RC1
- 时间：26 Mar 2026
- [下载地址](https://downloads.php.net/~saki/php-8.4.20RC1.tar.gz)
- sha256：d12ac12d1745ba1d5b7a0bd9005adf1ab2fe2ca97132eea5b8a45163998554cd
- md5：
