# 8.3.28RC1 configure help info

```bash
'configure' configures PHP 8.3.28RC1 to adapt to many kinds of systems.

Usage: src/8.3.28RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.28RC1
- 时间：06 Nov 2025
- [下载地址](https://downloads.php.net/~jakub/php-8.3.28RC1.tar.gz)
- sha256：b94c43815ccb642ed0e95f55e8558b266b8ef50c146d33eaefb5073147a3297c
- md5：
