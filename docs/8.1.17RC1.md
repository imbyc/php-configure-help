# 8.1.17RC1 configure help info

```bash
`configure' configures PHP 8.1.17RC1 to adapt to many kinds of systems.

Usage: src/8.1.17RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.17RC1
- 时间：02 Mar 2023
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.17RC1.tar.gz)
- sha256：331123a19ab0e4b9854e6fe7b495ef0498415b16d18113339cdef731a47b0130
- md5：
