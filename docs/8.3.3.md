# 8.3.3 configure help info

```bash
`configure' configures PHP 8.3.3 to adapt to many kinds of systems.

Usage: src/8.3.3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.3
- 时间：15 Feb 2024
- [下载地址](https://www.php.net/distributions/php-8.3.3.tar.gz)
