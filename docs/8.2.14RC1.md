# 8.2.14RC1 configure help info

```bash
`configure' configures PHP 8.2.14RC1 to adapt to many kinds of systems.

Usage: src/8.2.14RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.14RC1
- 时间：07 Dec 2023
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.14RC1.tar.gz)
- sha256：ba2df909626976aec27341625c69841988b8af48a6fafd53014c0ca6a366082f
- md5：
