# 8.4.13RC1 configure help info

```bash
'configure' configures PHP 8.4.13RC1 to adapt to many kinds of systems.

Usage: src/8.4.13RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.13RC1
- 时间：11 Sep 2025
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.13RC1.tar.gz)
- sha256：da738b85f7b6aad48073a93013eacb7fd275114c18b2c7ffac72a5801678ae9d
- md5：
