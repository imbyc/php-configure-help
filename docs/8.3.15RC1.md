# 8.3.15RC1 configure help info

```bash
'configure' configures PHP 8.3.15RC1 to adapt to many kinds of systems.

Usage: src/8.3.15RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.15RC1
- 时间：05 Dec 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.15RC1.tar.gz)
- sha256：e8a3e491d7ce56b02b530e96aff5c17e8331e0aa8d15aab0a2c19375c94571aa
- md5：
