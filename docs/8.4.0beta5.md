# 8.4.0beta5 configure help info

```bash
'configure' configures PHP 8.4.0beta5 to adapt to many kinds of systems.

Usage: src/8.4.0beta5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0beta5
- 时间：12 Sep 2024
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.0beta5.tar.gz)
- sha256：bf989b7bb8efba58344e5d1c893881303f0f0eaf7e0782201dd714b10ff6b88d
- md5：
