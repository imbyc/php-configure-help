# 8.5.7RC2 configure help info

```bash
'configure' configures PHP 8.5.7RC2 to adapt to many kinds of systems.

Usage: src/8.5.7RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.7RC2
- 时间：28 May 2026
- [下载地址](https://downloads.php.net/~edorian/php-8.5.7RC2.tar.gz)
- sha256：de7f6c6b374e939a38996a499371d8f7e9eeae7d95aee766ad8f025449d780e7
- md5：
