# 8.1.0beta3 configure help info

```bash
`configure' configures PHP 8.1.0beta3 to adapt to many kinds of systems.

Usage: src/8.1.0beta3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0beta3
- 时间：19 Aug 2021
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.0beta3.tar.gz)
- sha256：08bb5a9c36c5d2dda3cc1e7f6aa4293ffe6d92202cb6da7f4cb3ab5972fc1ffa
- md5：
