# 8.3.11RC1 configure help info

```bash
`configure' configures PHP 8.3.11RC1 to adapt to many kinds of systems.

Usage: src/8.3.11RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.11RC1
- 时间：15 Aug 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.11RC1.tar.gz)
- sha256：7f334fbe897786a17431da13a51b5f84c0286306fa8c7e3b9d5a521641c88ece
- md5：
