# 7.4.27RC1 configure help info

```bash
`configure' configures PHP 7.4.27RC1 to adapt to many kinds of systems.

Usage: src/7.4.27RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.27RC1
- 时间：02 Dec 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.27RC1.tar.gz)
- sha256：35aa5660819314a044a59b65b0732ff3b97d81a0db942fe319f9710bc67241cc
- md5：
