# 8.0.10 configure help info

```bash
`configure' configures PHP 8.0.10 to adapt to many kinds of systems.

Usage: src/8.0.10/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.10
- 时间：26 Aug 2021
- [下载地址](https://www.php.net/distributions/php-8.0.10.tar.gz)
