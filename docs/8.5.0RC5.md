# 8.5.0RC5 configure help info

```bash
`configure' configures PHP 8.5.0RC5 to adapt to many kinds of systems.

Usage: src/8.5.0RC5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0RC5
- 时间：13 Nov 2025
- [下载地址](https://downloads.php.net/~daniels/php-8.5.0RC5.tar.gz)
- sha256：c57233825070238a00dee8712487b4859fa35f597e3c365adddfad13578ffb87
- md5：
