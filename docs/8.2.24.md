# 8.2.24 configure help info

```bash
`configure' configures PHP 8.2.24 to adapt to many kinds of systems.

Usage: src/8.2.24/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.24
- 时间：26 Sep 2024
- [下载地址](https://www.php.net/distributions/php-8.2.24.tar.gz)
- sha256：5d26441969279a594e404bb9f2e17b6f74bb10606fe05911e739137673ae6c4c
- md5：
