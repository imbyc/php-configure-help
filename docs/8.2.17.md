# 8.2.17 configure help info

```bash
'configure' configures PHP 8.2.17 to adapt to many kinds of systems.

Usage: src/8.2.17/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.17
- 时间：14 Mar 2024
- [下载地址](https://www.php.net/distributions/php-8.2.17.tar.gz)
