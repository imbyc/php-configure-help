# 8.4.0alpha1 configure help info

```bash
'configure' configures PHP 8.4.0alpha1 to adapt to many kinds of systems.

Usage: src/8.4.0alpha1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0alpha1
- 时间：04 Jul 2024
- [下载地址](https://downloads.php.net/~saki/php-8.4.0alpha1.tar.gz)
- sha256：200fc03de5bf34bc621a24fce061bf3ec8d4d2fc8a676ed9b3f94ad129f69eab
- md5：
