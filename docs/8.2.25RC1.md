# 8.2.25RC1 configure help info

```bash
'configure' configures PHP 8.2.25RC1 to adapt to many kinds of systems.

Usage: src/8.2.25RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.25RC1
- 时间：10 Oct 2024
- [下载地址](https://downloads.php.net/~sergey/php-8.2.25RC1.tar.gz)
- sha256：ffc84d71f27250fb50a8a88dc61c47ad5a12d25e20bd9ca4a9c8925ced0e7d9c
- md5：
