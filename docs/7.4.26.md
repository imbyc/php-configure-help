# 7.4.26 configure help info

```bash
`configure' configures PHP 7.4.26 to adapt to many kinds of systems.

Usage: src/7.4.26/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.26
- 时间：18 Nov 2021
- [下载地址](https://www.php.net/distributions/php-7.4.26.tar.gz)
