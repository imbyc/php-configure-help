# 8.4.0alpha4 configure help info

```bash
'configure' configures PHP 8.4.0alpha4 to adapt to many kinds of systems.

Usage: src/8.4.0alpha4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0alpha4
- 时间：01 Aug 2024
- [下载地址](https://downloads.php.net/~saki/php-8.4.0alpha4.tar.gz)
- sha256：e79e971e1675d40dd29bd87d4458800b76121e9ad83d8145cf96274b327ec088
- md5：
