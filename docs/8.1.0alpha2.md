# 8.1.0alpha2 configure help info

```bash
`configure' configures PHP 8.1.0alpha2 to adapt to many kinds of systems.

Usage: src/8.1.0alpha2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0alpha2
- 时间：24 Jun 2021
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.0alpha2.tar.gz)
- sha256：9faa18e155e75ae9d40d09ddf4cab567321bd3673cbe9ff2a49b8ef357a768c1
- md5：
