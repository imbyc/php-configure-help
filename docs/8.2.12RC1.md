# 8.2.12RC1 configure help info

```bash
`configure' configures PHP 8.2.12RC1 to adapt to many kinds of systems.

Usage: src/8.2.12RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.12RC1
- 时间：12 Oct 2023
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.12RC1.tar.gz)
- sha256：40ed39c34cb4c4440226ac6a4e2b4143d1ed4b1f7ae60c4cad47b6a0cc60f1fd
- md5：
