# 8.0.14RC1 configure help info

```bash
`configure' configures PHP 8.0.14RC1 to adapt to many kinds of systems.

Usage: src/8.0.14RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.14RC1
- 时间：02 Dec 2021
- [下载地址](https://downloads.php.net/~pollita/php-8.0.14RC1.tar.gz)
- sha256：ee1fd3fa5ba7162412da8d7cdfe6e7ea0ef582dd0a6aae5b3ca77a8d90472195
- md5：
