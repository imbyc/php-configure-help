# 8.0.21RC1 configure help info

```bash
`configure' configures PHP 8.0.21RC1 to adapt to many kinds of systems.

Usage: src/8.0.21RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.21RC1
- 时间：26 Jun 2022
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.21RC1.tar.gz)
- sha256：414fdbb6482cd5258b408f2e1cfc51190d9715603be8acf6423428a587e9c5fe
- md5：
