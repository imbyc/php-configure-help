# 8.4.0RC1 configure help info

```bash
'configure' configures PHP 8.4.0RC1 to adapt to many kinds of systems.

Usage: src/8.4.0RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0RC1
- 时间：26 Sep 2024
- [下载地址](https://downloads.php.net/~saki/php-8.4.0RC1.tar.gz)
- sha256：ff924ce24493cd546c7227c2cedf75c32d23815b0a6e5c1658d9b005837631ff
- md5：
