# 8.5.1RC1 configure help info

```bash
'configure' configures PHP 8.5.1RC1 to adapt to many kinds of systems.

Usage: src/8.5.1RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.1RC1
- 时间：5 Dec 2025
- [下载地址](https://downloads.php.net/~edorian/php-8.5.1RC1.tar.gz)
- sha256：b328792a6ebe2b5bfb9e1d616cea40ab9c6d8b13e141fda2bf511ca6d49a6ce1
- md5：
