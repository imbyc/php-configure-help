# 8.2.0RC6 configure help info

```bash
`configure' configures PHP 8.2.0RC6 to adapt to many kinds of systems.

Usage: src/8.2.0RC6/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0RC6
- 时间：10 Nov 2022
- [下载地址](https://downloads.php.net/~sergey/php-8.2.0RC6.tar.gz)
- sha256：c09b17facf5dae473b1f3d50ae4b1d90028ea3c27b1ce422414bb75d477cabc3
- md5：
