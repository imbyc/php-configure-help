# 8.3.2RC1 configure help info

```bash
`configure' configures PHP 8.3.2RC1 to adapt to many kinds of systems.

Usage: src/8.3.2RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.2RC1
- 时间：04 Jan 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.2RC1.tar.gz)
- sha256：3ad40357e83b24e0b0c3e6423f595cd54a471ef05b37d65b2e602def08b80ea1
- md5：
