# 8.2.13 configure help info

```bash
`configure' configures PHP 8.2.13 to adapt to many kinds of systems.

Usage: src/8.2.13/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.13
- 时间：23 Nov 2023
- [下载地址](https://www.php.net/distributions/php-8.2.13.tar.gz)
