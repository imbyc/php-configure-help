# 8.0.26RC1 configure help info

```bash
`configure' configures PHP 8.0.26RC1 to adapt to many kinds of systems.

Usage: src/8.0.26RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.26RC1
- 时间：10 Nov 2022
- [下载地址](https://downloads.php.net/~pollita/php-8.0.26RC1.tar.gz)
- sha256：74066f7023d4b6e66a6b6208f86591c699f257a648bd803d87cf3a32e21f0c5d
- md5：
