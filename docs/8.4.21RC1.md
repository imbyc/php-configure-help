# 8.4.21RC1 configure help info

```bash
'configure' configures PHP 8.4.21RC1 to adapt to many kinds of systems.

Usage: src/8.4.21RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.21RC1
- 时间：23 Apr 2026
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.21RC1.tar.gz)
- sha256：e4c3eb09b3948bda0a0e41c73424a73c1d3ca6c7ee81efb22f26f07cb7476929
- md5：
