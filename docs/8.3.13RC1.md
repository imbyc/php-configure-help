# 8.3.13RC1 configure help info

```bash
`configure' configures PHP 8.3.13RC1 to adapt to many kinds of systems.

Usage: src/8.3.13RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.13RC1
- 时间：10 Oct 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.13RC1.tar.gz)
- sha256：5eb82ce81b81c930f3ac406616b70a5d4b9efc0915b60411d9838933a4b2ebf6
- md5：
