# 8.5.6RC3 configure help info

```bash
`configure' configures PHP 8.5.6RC3 to adapt to many kinds of systems.

Usage: src/8.5.6RC3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.6RC3
- 时间：30 Apr 2026
- [下载地址](https://downloads.php.net/~daniels/php-8.5.6RC3.tar.gz)
- sha256：01e12f91a9c6924d42d208a1d97a32930562caa410f49f0caae62e07bfe014ff
- md5：
