# 8.2.7 configure help info

```bash
`configure' configures PHP 8.2.7 to adapt to many kinds of systems.

Usage: src/8.2.7/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.7
- 时间：08 Jun 2023
- [下载地址](https://www.php.net/distributions/php-8.2.7.tar.gz)
