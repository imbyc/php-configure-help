# 8.0.19RC1 configure help info

```bash
`configure' configures PHP 8.0.19RC1 to adapt to many kinds of systems.

Usage: src/8.0.19RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.19RC1
- 时间：28 Apr 2022
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.19RC1.tar.gz)
- sha256：13536d2cb80c74f008ad90a7738e2eae7b4b308ea928d0effcf61976f18ec9f0
- md5：
