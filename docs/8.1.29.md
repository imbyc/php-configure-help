# 8.1.29 configure help info

```bash
'configure' configures PHP 8.1.29 to adapt to many kinds of systems.

Usage: src/8.1.29/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.29
- 时间：06 Jun 2024
- [下载地址](https://www.php.net/distributions/php-8.1.29.tar.gz)
