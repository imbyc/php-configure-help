# 8.4.12RC1 configure help info

```bash
'configure' configures PHP 8.4.12RC1 to adapt to many kinds of systems.

Usage: src/8.4.12RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.12RC1
- 时间：14 Aug 2025
- [下载地址](https://downloads.php.net/~saki/php-8.4.12RC1.tar.gz)
- sha256：0392cd9d3f6310b3b266e8dd71d2852630854ee0b6d21facbc2fb301bc29e8e2
- md5：
