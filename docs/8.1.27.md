# 8.1.27 configure help info

```bash
`configure' configures PHP 8.1.27 to adapt to many kinds of systems.

Usage: src/8.1.27/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.27
- 时间：21 Dec 2023
- [下载地址](https://www.php.net/distributions/php-8.1.27.tar.gz)
