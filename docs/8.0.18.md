# 8.0.18 configure help info

```bash
`configure' configures PHP 8.0.18 to adapt to many kinds of systems.

Usage: src/8.0.18/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.18
- 时间：14 Apr 2022
- [下载地址](https://www.php.net/distributions/php-8.0.18.tar.gz)
