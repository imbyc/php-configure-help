# 8.1.17 configure help info

```bash
`configure' configures PHP 8.1.17 to adapt to many kinds of systems.

Usage: src/8.1.17/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.17
- 时间：16 Mar 2023
- [下载地址](https://www.php.net/distributions/php-8.1.17.tar.gz)
