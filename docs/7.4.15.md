# 7.4.15 configure help info

```bash
`configure' configures PHP 7.4.15 to adapt to many kinds of systems.

Usage: src/7.4.15/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.15
- 时间：04 Feb 2021
- [下载地址](https://www.php.net/distributions/php-7.4.15.tar.gz)
