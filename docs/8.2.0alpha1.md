# 8.2.0alpha1 configure help info

```bash
`configure' configures PHP 8.2.0alpha1 to adapt to many kinds of systems.

Usage: src/8.2.0alpha1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0alpha1
- 时间：9 Jun 2022
- [下载地址](https://downloads.php.net/~sergey/php-8.2.0alpha1.tar.gz)
- sha256：d4413c05a8012d99b2bd9b9bc9ba7a65fe9fd5bf457085d51d57044f691337d8
- md5：
