# 8.2.13RC1 configure help info

```bash
`configure' configures PHP 8.2.13RC1 to adapt to many kinds of systems.

Usage: src/8.2.13RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.13RC1
- 时间：09 Nov 2023
- [下载地址](https://downloads.php.net/~sergey/php-8.2.13RC1.tar.gz)
- sha256：501f5813fab2fb177f449b19301ed4ff84396bd4ea46aef1c73e8bcc63afc902
- md5：
