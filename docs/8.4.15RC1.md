# 8.4.15RC1 configure help info

```bash
'configure' configures PHP 8.4.15RC1 to adapt to many kinds of systems.

Usage: src/8.4.15RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.15RC1
- 时间：06 Nov 2025
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.15RC1.tar.gz)
- sha256：e0fa65261c114161b1c95274c0e9a4f0e0b77d4895104e99055c907806c8f90f
- md5：
