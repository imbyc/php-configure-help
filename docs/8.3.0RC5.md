# 8.3.0RC5 configure help info

```bash
`configure' configures PHP 8.3.0RC5 to adapt to many kinds of systems.

Usage: src/8.3.0RC5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.0RC5
- 时间：26 Oct 2023
- [下载地址](https://downloads.php.net/~jakub/php-8.3.0RC5.tar.gz)
- sha256：9c7f8755bfd7b915e48874ab4aee25bbe4c40db9a5bf1aff150a6ca076fd33c0
- md5：
