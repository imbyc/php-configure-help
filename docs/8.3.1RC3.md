# 8.3.1RC3 configure help info

```bash
`configure' configures PHP 8.3.1RC3 to adapt to many kinds of systems.

Usage: src/8.3.1RC3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.1RC3
- 时间：07 Dec 2023
- [下载地址](https://downloads.php.net/~eric/php-8.3.1RC3.tar.gz)
- sha256：b548b25e77e6249a8041d96ad47eb6ea41d19dd281f3a01cdf0c954fda5bdab2
- md5：
