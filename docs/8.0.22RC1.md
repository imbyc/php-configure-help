# 8.0.22RC1 configure help info

```bash
`configure' configures PHP 8.0.22RC1 to adapt to many kinds of systems.

Usage: src/8.0.22RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.22RC1
- 时间：21 Jul 2022
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.22RC1.tar.gz)
- sha256：a64b4f5cd8377c95eef46572c4e59d4f4dd17792f52c3fca46476c8803c8bf40
- md5：
