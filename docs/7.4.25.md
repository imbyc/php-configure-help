# 7.4.25 configure help info

```bash
`configure' configures PHP 7.4.25 to adapt to many kinds of systems.

Usage: src/7.4.25/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.25
- 时间：21 Oct 2021
- [下载地址](https://www.php.net/distributions/php-7.4.25.tar.gz)
