# 8.5.0beta1 configure help info

```bash
'configure' configures PHP 8.5.0beta1 to adapt to many kinds of systems.

Usage: src/8.5.0beta1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0beta1
- 时间：14 Aug 2025
- [下载地址](https://downloads.php.net/~edorian/php-8.5.0beta1.tar.gz)
- sha256：d28f6de0744fa733db898ddcdeaa784a5e87ec1b4b4822e83529d9a76229ea61
- md5：
