# 8.3.7RC1 configure help info

```bash
`configure' configures PHP 8.3.7RC1 to adapt to many kinds of systems.

Usage: src/8.3.7RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.7RC1
- 时间：25 Apr 2024
- [下载地址](https://downloads.php.net/~jakub/php-8.3.7RC1.tar.gz)
- sha256：57f2d6dc99444c95de2777d9776279501f8bb7f89e33a8dd7885058ef8a41905
- md5：
