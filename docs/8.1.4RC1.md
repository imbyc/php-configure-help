# 8.1.4RC1 configure help info

```bash
`configure' configures PHP 8.1.4RC1 to adapt to many kinds of systems.

Usage: src/8.1.4RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.4RC1
- 时间：03 Mar 2022
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.4RC1.tar.gz)
- sha256：2f7078b0a04de9647564e80db73f2cd81091336a12461f1f07bd85d4c95942fe
- md5：
