# 8.2.1RC1 configure help info

```bash
`configure' configures PHP 8.2.1RC1 to adapt to many kinds of systems.

Usage: src/8.2.1RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.1RC1
- 时间：15 Dec 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.1RC1.tar.gz)
- sha256：3e6e9964cac04618db84905a0b984e03a7bb7327fdf18f87c884a86495643adb
- md5：
