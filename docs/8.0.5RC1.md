# 8.0.5RC1 configure help info

```bash
`configure' configures PHP 8.0.5RC1 to adapt to many kinds of systems.

Usage: src/8.0.5RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.5RC1
- 时间：15 Apr 2021
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.5RC1.tar.gz)
- sha256：344bde64fb10f7b8a335c242dd18804ff0c51e4bf7b4290dca846bb73727b76f
- md5：
