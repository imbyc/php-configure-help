# 8.3.14RC1 configure help info

```bash
`configure' configures PHP 8.3.14RC1 to adapt to many kinds of systems.

Usage: src/8.3.14RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.14RC1
- 时间：07 Nov 2024
- [下载地址](https://downloads.php.net/~eric/php-8.3.14RC1.tar.gz)
- sha256：4629249cea0cb35ed182c4fa88383d036530fbc165b796a916e4ad0f9e892a29
- md5：
