# 8.1.18RC1 configure help info

```bash
`configure' configures PHP 8.1.18RC1 to adapt to many kinds of systems.

Usage: src/8.1.18RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.18RC1
- 时间：30 Mar 2023
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.18RC1.tar.gz)
- sha256：f7eb7271c0a35b8d041cfb7cca116d3d497c536e8c0f6799bf1678845317a48d
- md5：
