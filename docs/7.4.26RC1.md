# 7.4.26RC1 configure help info

```bash
`configure' configures PHP 7.4.26RC1 to adapt to many kinds of systems.

Usage: src/7.4.26RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.26RC1
- 时间：04 Oct 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.26RC1.tar.gz)
- sha256：e7512664dd37405a5be4a134ad1bfa53b5dde5a4b0692de7677f8ba6a961fb98
- md5：
