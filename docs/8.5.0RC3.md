# 8.5.0RC3 configure help info

```bash
`configure' configures PHP 8.5.0RC3 to adapt to many kinds of systems.

Usage: src/8.5.0RC3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0RC3
- 时间：23 Oct 2025
- [下载地址](https://downloads.php.net/~daniels/php-8.5.0RC3.tar.gz)
