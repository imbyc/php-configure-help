# 8.3.12RC1 configure help info

```bash
`configure' configures PHP 8.3.12RC1 to adapt to many kinds of systems.

Usage: src/8.3.12RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.12RC1
- 时间：12 Sep 2024
- [下载地址](https://downloads.php.net/~eric/php-8.3.12RC1.tar.gz)
- sha256：fa7a98681706c2b36f8b7afc8021dbe6d41613ea3588532e8a831c4d459aab3b
- md5：
