# 7.4.10 configure help info

```bash
`configure' configures PHP 7.4.10 to adapt to many kinds of systems.

Usage: src/7.4.10/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.10
- 时间：03 Sep 2020
- [下载地址](https://www.php.net/distributions/php-7.4.10.tar.gz)
