# 8.2.27 configure help info

```bash
'configure' configures PHP 8.2.27 to adapt to many kinds of systems.

Usage: src/8.2.27/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.27
- 时间：19 Dec 2024
- [下载地址](https://www.php.net/distributions/php-8.2.27.tar.gz)
