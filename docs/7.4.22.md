# 7.4.22 configure help info

```bash
`configure' configures PHP 7.4.22 to adapt to many kinds of systems.

Usage: src/7.4.22/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.22
- 时间：29 Jul 2021
- [下载地址](https://www.php.net/distributions/php-7.4.22.tar.gz)
