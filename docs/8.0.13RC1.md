# 8.0.13RC1 configure help info

```bash
`configure' configures PHP 8.0.13RC1 to adapt to many kinds of systems.

Usage: src/8.0.13RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.13RC1
- 时间：04 Nov 2021
- [下载地址](https://downloads.php.net/~pollita/php-8.0.13RC1.tar.gz)
- sha256：44274daf3ab5ffa75df88e555a502ac13262e12f5e3626d84241157964f95c1d
- md5：
