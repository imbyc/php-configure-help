# 8.1.1RC1 configure help info

```bash
`configure' configures PHP 8.1.1RC1 to adapt to many kinds of systems.

Usage: src/8.1.1RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.1RC1
- 时间：02 Dec 2021
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.1RC1.tar.gz)
- sha256：a0ec5d6f3a88ecc12f128346696abc5d998622f199d5115fe65c73a756e38805
- md5：
