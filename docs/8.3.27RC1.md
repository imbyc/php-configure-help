# 8.3.27RC1 configure help info

```bash
`configure' configures PHP 8.3.27RC1 to adapt to many kinds of systems.

Usage: src/8.3.27RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.27RC1
- 时间：09 Oct 2025
- [下载地址](https://downloads.php.net/~eric/php-8.3.27RC1.tar.gz)
- sha256：ceb41d62a352335e973fc4f1a41c362ee390afe177274efaa614db702daf2f4e
- md5：
