# 8.2.11RC1 configure help info

```bash
`configure' configures PHP 8.2.11RC1 to adapt to many kinds of systems.

Usage: src/8.2.11RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.11RC1
- 时间：14 Sep 2023
- [下载地址](https://downloads.php.net/~sergey/php-8.2.11RC1.tar.gz)
- sha256：ba9dee1948b2a577ffcbf8df43217d9e1760587a8fcc66a19d45fab6bd197111
- md5：
