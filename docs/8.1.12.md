# 8.1.12 configure help info

```bash
`configure' configures PHP 8.1.12 to adapt to many kinds of systems.

Usage: src/8.1.12/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.12
- 时间：27 Oct 2022
- [下载地址](https://www.php.net/distributions/php-8.1.12.tar.gz)
