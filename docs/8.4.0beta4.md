# 8.4.0beta4 configure help info

```bash
'configure' configures PHP 8.4.0beta4 to adapt to many kinds of systems.

Usage: src/8.4.0beta4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0beta4
- 时间：29 Aug 2024
- [下载地址](https://downloads.php.net/~saki/php-8.4.0beta4.tar.gz)
- sha256：897fb80a8cfb8c26e2c62b3e4b3518961c747e25a4d700ceacd431b476f2d9a7
- md5：
