# 8.5.5RC1 configure help info

```bash
'configure' configures PHP 8.5.5RC1 to adapt to many kinds of systems.

Usage: src/8.5.5RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.5RC1
- 时间：26 Mar 2026
- [下载地址](https://downloads.php.net/~edorian/php-8.5.5RC1.tar.gz)
- sha256：39ba7a41078a4d4c63b71acefbd14f4e9de14d314ad37dca3a75ef699284592e
- md5：
