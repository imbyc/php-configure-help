# 8.1.0RC3 configure help info

```bash
`configure' configures PHP 8.1.0RC3 to adapt to many kinds of systems.

Usage: src/8.1.0RC3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0RC3
- 时间：30 Sep 2021
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.0RC3.tar.gz)
- sha256：53a5a4d6c6cd0a32c70df1b38910159df0d616b1f786ca096a2d0f002973269f
- md5：
