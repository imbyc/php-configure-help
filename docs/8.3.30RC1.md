# 8.3.30RC1 configure help info

```bash
'configure' configures PHP 8.3.30RC1 to adapt to many kinds of systems.

Usage: src/8.3.30RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.30RC1
- 时间：01 Jan 2026
- [下载地址](https://downloads.php.net/~jakub/php-8.3.30RC1.tar.gz)
- sha256：ef8c41dc1af1371e70dd1c9d8caaab5ee47ecf712206a5496e0510417b53fcd7
- md5：
