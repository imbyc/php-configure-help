# 8.3.23RC1 configure help info

```bash
`configure' configures PHP 8.3.23RC1 to adapt to many kinds of systems.

Usage: src/8.3.23RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.23RC1
- 时间：19 Jun 2025
- [下载地址](https://downloads.php.net/~eric/php-8.3.23RC1.tar.gz)
- sha256：dbe76e6baf4740565d5bcc3169d198dbe187b80ce2f00c1ce8d8c17baf4c5432
- md5：
