# 8.5.0alpha4 configure help info

```bash
`configure' configures PHP 8.5.0alpha4 to adapt to many kinds of systems.

Usage: src/8.5.0alpha4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0alpha4
- 时间：31 Jul 2025
- [下载地址](https://downloads.php.net/~daniels/php-8.5.0alpha4.tar.gz)
- sha256：0d8df870b8de569e2cf3530a8bb8f2b627b1f7f7f9212a76ce3a5b3742903f37
- md5：
