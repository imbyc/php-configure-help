# 8.5.1RC2 configure help info

```bash
'configure' configures PHP 8.5.1RC2 to adapt to many kinds of systems.

Usage: src/8.5.1RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.1RC2
- 时间：12 Dec 2025
- [下载地址](https://downloads.php.net/~edorian/php-8.5.1RC2.tar.gz)
- sha256：394ae2e58140107199fe25c44cb70382fb4b4a4106a3e127ce0220b1cffc9089
- md5：
