# 8.2.0RC3 configure help info

```bash
`configure' configures PHP 8.2.0RC3 to adapt to many kinds of systems.

Usage: src/8.2.0RC3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0RC3
- 时间：29 Sep 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.0RC3.tar.gz)
- sha256：4a9b27e1d7f4c0c3e6eb8a69870f488d90768268d0098de1b2712946fb50ddb5
- md5：
