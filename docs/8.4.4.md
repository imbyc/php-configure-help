# 8.4.4 configure help info

```bash
'configure' configures PHP 8.4.4 to adapt to many kinds of systems.

Usage: src/8.4.4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.4
- 时间：13 Feb 2025
- [下载地址](https://www.php.net/distributions/php-8.4.4.tar.gz)
