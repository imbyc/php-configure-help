# 8.1.19 configure help info

```bash
`configure' configures PHP 8.1.19 to adapt to many kinds of systems.

Usage: src/8.1.19/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.19
- 时间：11 May 2023
- [下载地址](https://www.php.net/distributions/php-8.1.19.tar.gz)
