# 8.1.28 configure help info

```bash
'configure' configures PHP 8.1.28 to adapt to many kinds of systems.

Usage: src/8.1.28/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.28
- 时间：11 Apr 2024
- [下载地址](https://www.php.net/distributions/php-8.1.28.tar.gz)
