# 8.2.5RC1 configure help info

```bash
`configure' configures PHP 8.2.5RC1 to adapt to many kinds of systems.

Usage: src/8.2.5RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.5RC1
- 时间：30 Mar 2023
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.5RC1.tar.gz)
- sha256：f282407a71036e0619c7eadb0a42955ff70cee1133abeb472aad450d6e9911bb
- md5：
