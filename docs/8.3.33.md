# 8.3.33 configure help info

```bash
`configure' configures PHP 8.3.33 to adapt to many kinds of systems.

Usage: src/8.3.33/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.33
- 时间：30 Jul 2026
- [下载地址](https://www.php.net/distributions/php-8.3.33.tar.gz)
