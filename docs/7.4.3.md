# 7.4.3 configure help info

```bash
`configure' configures PHP 7.4.3 to adapt to many kinds of systems.

Usage: src/7.4.3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.3
- 时间：20 Feb 2020
- [下载地址](https://www.php.net/distributions/php-7.4.3.tar.gz)
