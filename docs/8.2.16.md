# 8.2.16 configure help info

```bash
`configure' configures PHP 8.2.16 to adapt to many kinds of systems.

Usage: src/8.2.16/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.16
- 时间：15 Feb 2024
- [下载地址](https://www.php.net/distributions/php-8.2.16.tar.gz)
