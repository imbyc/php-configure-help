# 8.2.25 configure help info

```bash
'configure' configures PHP 8.2.25 to adapt to many kinds of systems.

Usage: src/8.2.25/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.25
- 时间：24 Oct 2024
- [下载地址](https://www.php.net/distributions/php-8.2.25.tar.gz)
- sha256：7fe7ba6e3e66cd0e61cfa95341e6aefc8790030a7867333f54aef5fb78aad18b
- md5：
