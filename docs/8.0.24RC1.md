# 8.0.24RC1 configure help info

```bash
`configure' configures PHP 8.0.24RC1 to adapt to many kinds of systems.

Usage: src/8.0.24RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.24RC1
- 时间：15 Sep 2022
- [下载地址](https://downloads.php.net/~pollita/php-8.0.24RC1.tar.gz)
- sha256：f2b5a72e0500ea2e103b4d8c3241ffa174461abe0352a2cd9f99d5e3e0b7250b
- md5：
