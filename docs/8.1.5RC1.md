# 8.1.5RC1 configure help info

```bash
`configure' configures PHP 8.1.5RC1 to adapt to many kinds of systems.

Usage: src/8.1.5RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.5RC1
- 时间：31 Mar 2022
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.5RC1.tar.gz)
- sha256：c37749d942ad68d5797193258d5b94cde75e6cae2ec16a62de24808b07350b50
- md5：
