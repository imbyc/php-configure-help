# 8.1.7RC1 configure help info

```bash
`configure' configures PHP 8.1.7RC1 to adapt to many kinds of systems.

Usage: src/8.1.7RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.7RC1
- 时间：27 May 2022
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.7RC1.tar.gz)
- sha256：cce6f4c324dcd1db1b2983b3d76d8f6450545f9559373d8ca63b1b8c2ed3ca5d
- md5：
