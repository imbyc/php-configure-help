# 8.1.0alpha1 configure help info

```bash
`configure' configures PHP 8.1.0alpha1 to adapt to many kinds of systems.

Usage: src/8.1.0alpha1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0alpha1
- 时间：10 Jun 2021
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.0alpha1.tar.gz)
- sha256：279edf3226e562aedad5caf593782964c430a1ebfd367221e2488e54d1be3c74
- md5：
