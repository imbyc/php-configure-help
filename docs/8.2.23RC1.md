# 8.2.23RC1 configure help info

```bash
'configure' configures PHP 8.2.23RC1 to adapt to many kinds of systems.

Usage: src/8.2.23RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.23RC1
- 时间：15 Aug 2024
- [下载地址](https://downloads.php.net/~sergey/php-8.2.23RC1.tar.gz)
- sha256：73bcde9a7eef973e5c9f749dbf7f3b1cb5eaaee5404a3cad6caa376b02f2ce9e
- md5：
