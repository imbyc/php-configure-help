# 8.0.17RC1 configure help info

```bash
`configure' configures PHP 8.0.17RC1 to adapt to many kinds of systems.

Usage: src/8.0.17RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.17RC1
- 时间：03 Mar 2022
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.17RC1.tar.gz)
- sha256：829c301145dc8c3a4288da23acebd1a8f3c23fe44e35a33f17ee62d0f7a2ee1e
- md5：
