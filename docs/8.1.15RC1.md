# 8.1.15RC1 configure help info

```bash
`configure' configures PHP 8.1.15RC1 to adapt to many kinds of systems.

Usage: src/8.1.15RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.15RC1
- 时间：19 Jan 2023
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.15RC1.tar.gz)
- sha256：b8df1843905c001b5cc0bffb71ece3c788d822e6eaa1422dc449b6c446eba3ad
- md5：
