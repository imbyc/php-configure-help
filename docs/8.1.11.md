# 8.1.11 configure help info

```bash
`configure' configures PHP 8.1.11 to adapt to many kinds of systems.

Usage: src/8.1.11/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.11
- 时间：29 Sep 2022
- [下载地址](https://www.php.net/distributions/php-8.1.11.tar.gz)
