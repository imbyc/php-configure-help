# 8.0.20RC1 configure help info

```bash
`configure' configures PHP 8.0.20RC1 to adapt to many kinds of systems.

Usage: src/8.0.20RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.20RC1
- 时间：26 May 2022
- [下载地址](https://downloads.php.net/~pollita/php-8.0.20RC1.tar.gz)
- sha256：c2e1dc4f0162700c2dc75616c47df28087bfca1d10d66ef97a7b75b15330383e
- md5：
