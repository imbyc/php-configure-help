# 8.2.0RC4 configure help info

```bash
`configure' configures PHP 8.2.0RC4 to adapt to many kinds of systems.

Usage: src/8.2.0RC4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0RC4
- 时间：13 Oct 2022
- [下载地址](https://downloads.php.net/~sergey/php-8.2.0RC4.tar.gz)
- sha256：7b344d4763a99d01a13fda253941617fc1f732f9ee1ee1d6caccceb1e74e53e7
- md5：
