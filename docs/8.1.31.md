# 8.1.31 configure help info

```bash
'configure' configures PHP 8.1.31 to adapt to many kinds of systems.

Usage: src/8.1.31/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.31
- 时间：21 Nov 2024
- [下载地址](https://www.php.net/distributions/php-8.1.31.tar.gz)
