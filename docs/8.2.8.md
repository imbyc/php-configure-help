# 8.2.8 configure help info

```bash
`configure' configures PHP 8.2.8 to adapt to many kinds of systems.

Usage: src/8.2.8/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.8
- 时间：06 Jul 2023
- [下载地址](https://www.php.net/distributions/php-8.2.8.tar.gz)
