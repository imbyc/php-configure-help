# 7.4.16 configure help info

```bash
`configure' configures PHP 7.4.16 to adapt to many kinds of systems.

Usage: src/7.4.16/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.16
- 时间：04 Mar 2021
- [下载地址](https://www.php.net/distributions/php-7.4.16.tar.gz)
