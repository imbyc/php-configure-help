# 8.4.0RC4 configure help info

```bash
'configure' configures PHP 8.4.0RC4 to adapt to many kinds of systems.

Usage: src/8.4.0RC4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.0RC4
- 时间：07 Nov 2024
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.0RC4.tar.gz)
- sha256：3964fee49465e6fcae77ad030ae31aa720ade0a51c53df6e255e36eb867fd4b2
- md5：
