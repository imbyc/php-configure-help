# 8.1.0RC1 configure help info

```bash
`configure' configures PHP 8.1.0RC1 to adapt to many kinds of systems.

Usage: src/8.1.0RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0RC1
- 时间：02 Sep 2021
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.0RC1.tar.gz)
- sha256：8a4fad22c02909705c740833bf99e3039d7d3971a55deb998206f6d67151c294
- md5：
