# 7.4.21RC1 configure help info

```bash
`configure' configures PHP 7.4.21RC1 to adapt to many kinds of systems.

Usage: src/7.4.21RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.21RC1
- 时间：17 Jun 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.21RC1.tar.gz)
- sha256：6d6813294ebd241f077dd6bdfa234e3ebe64990aaa693c6eecaa550be34b95f8
- md5：
