# 8.3.5RC1 configure help info

```bash
`configure' configures PHP 8.3.5RC1 to adapt to many kinds of systems.

Usage: src/8.3.5RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.5RC1
- 时间：28 Mar 2024
- [下载地址](https://downloads.php.net/~eric/php-8.3.5RC1.tar.gz)
- sha256：ec3ed5c55922d872d91667d5c6ccf995d50811ca6e64dad2cb0fa2fcc192c875
- md5：
