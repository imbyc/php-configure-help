# 8.3.21 configure help info

```bash
`configure' configures PHP 8.3.21 to adapt to many kinds of systems.

Usage: src/8.3.21/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.21
- 时间：8 May 2025
- [下载地址](https://www.php.net/distributions/php-8.3.21.tar.gz)
