# 8.2.23 configure help info

```bash
'configure' configures PHP 8.2.23 to adapt to many kinds of systems.

Usage: src/8.2.23/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.23
- 时间：29 Aug 2024
- [下载地址](https://www.php.net/distributions/php-8.2.23.tar.gz)
- sha256：f5cb5f0e063bcc632c60a8f26af63b19d5f924f1fc54b4471d88cfaa865d6917
- md5：
