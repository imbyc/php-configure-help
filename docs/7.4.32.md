# 7.4.32 configure help info

```bash
`configure' configures PHP 7.4.32 to adapt to many kinds of systems.

Usage: src/7.4.32/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.32
- 时间：29 Sep 2022
- [下载地址](https://www.php.net/distributions/php-7.4.32.tar.gz)
