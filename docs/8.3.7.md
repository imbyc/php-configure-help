# 8.3.7 configure help info

```bash
`configure' configures PHP 8.3.7 to adapt to many kinds of systems.

Usage: src/8.3.7/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.7
- 时间：09 May 2024
- [下载地址](https://www.php.net/distributions/php-8.3.7.tar.gz)
