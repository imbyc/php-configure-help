# 7.4.7 configure help info

```bash
`configure' configures PHP 7.4.7 to adapt to many kinds of systems.

Usage: src/7.4.7/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.7
- 时间：11 June 2020
- [下载地址](https://www.php.net/distributions/php-7.4.7.tar.gz)
