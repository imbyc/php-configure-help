# 8.3.2 configure help info

```bash
`configure' configures PHP 8.3.2 to adapt to many kinds of systems.

Usage: src/8.3.2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.2
- 时间：18 Jan 2024
- [下载地址](https://www.php.net/distributions/php-8.3.2.tar.gz)
