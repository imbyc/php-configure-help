# 8.5.4RC1 configure help info

```bash
`configure' configures PHP 8.5.4RC1 to adapt to many kinds of systems.

Usage: src/8.5.4RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.4RC1
- 时间：26 Feb 2026
- [下载地址](https://downloads.php.net/~daniels/php-8.5.4RC1.tar.gz)
- sha256：33681975c07c5f135c350663b842bf90872eb4b1b7261d6b8b3df019985e0d36
- md5：
