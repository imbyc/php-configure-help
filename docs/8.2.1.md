# 8.2.1 configure help info

```bash
`configure' configures PHP 8.2.1 to adapt to many kinds of systems.

Usage: src/8.2.1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.1
- 时间：05 Jan 2023
- [下载地址](https://www.php.net/distributions/php-8.2.1.tar.gz)
