# 8.1.2RC1 configure help info

```bash
`configure' configures PHP 8.1.2RC1 to adapt to many kinds of systems.

Usage: src/8.1.2RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.2RC1
- 时间：06 Jan 2022
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.2RC1.tar.gz)
- sha256：15e4f98ed40af88e87753737eaa4f8e2d0bbb7396cb96cf501c7f77a4aec0f2d
- md5：
