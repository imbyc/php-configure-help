# 8.0.7 configure help info

```bash
`configure' configures PHP 8.0.7 to adapt to many kinds of systems.

Usage: src/8.0.7/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.7
- 时间：03 Jun 2021
- [下载地址](https://www.php.net/distributions/php-8.0.7.tar.gz)
