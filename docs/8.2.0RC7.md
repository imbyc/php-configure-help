# 8.2.0RC7 configure help info

```bash
`configure' configures PHP 8.2.0RC7 to adapt to many kinds of systems.

Usage: src/8.2.0RC7/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0RC7
- 时间：24 Nov 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.0RC7.tar.gz)
- sha256：2d123b64bdff600e142bc93fea9fcc7248878fd4c3ca9f376d06d14dab19613b
- md5：
