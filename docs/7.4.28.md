# 7.4.28 configure help info

```bash
`configure' configures PHP 7.4.28 to adapt to many kinds of systems.

Usage: src/7.4.28/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.28
- 时间：17 Feb 2022
- [下载地址](https://www.php.net/distributions/php-7.4.28.tar.gz)
