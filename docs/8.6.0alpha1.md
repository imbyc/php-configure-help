# 8.6.0alpha1 configure help info

```bash
'configure' configures PHP 8.6.0alpha1 to adapt to many kinds of systems.

Usage: src/8.6.0alpha1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.6.0alpha1
- 时间：2 July 2026
- [下载地址](https://downloads.php.net/~mbeccati/php-8.6.0alpha1.tar.gz)
- sha256：253d9ff1f03bd17ddf0aaed423b59a37d8f9567858df44d30d3c42c14301a7ab
- md5：
