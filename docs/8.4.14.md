# 8.4.14 configure help info

```bash
'configure' configures PHP 8.4.14 to adapt to many kinds of systems.

Usage: src/8.4.14/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.14
- 时间：23 Oct 2025
- [下载地址](https://www.php.net/distributions/php-8.4.14.tar.gz)
