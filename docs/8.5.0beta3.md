# 8.5.0beta3 configure help info

```bash
'configure' configures PHP 8.5.0beta3 to adapt to many kinds of systems.

Usage: src/8.5.0beta3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0beta3
- 时间：11 Sep 2025
- [下载地址](https://downloads.php.net/~edorian/php-8.5.0beta3.tar.gz)
- sha256：ff3f5a8c73c4b84883ef0e3870543c078d324c46ccef2eb85c66cb88124e7a55
- md5：
