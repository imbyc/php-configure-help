# 7.4.18RC1 configure help info

```bash
`configure' configures PHP 7.4.18RC1 to adapt to many kinds of systems.

Usage: src/7.4.18RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.18RC1
- 时间：15 Apr 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.18RC1.tar.gz)
- sha256：feeeef25e933d9598e4294e8e8b0b5d825e7fe685dcb283f52845927548b24c0
- md5：
