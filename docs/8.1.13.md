# 8.1.13 configure help info

```bash
`configure' configures PHP 8.1.13 to adapt to many kinds of systems.

Usage: src/8.1.13/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.13
- 时间：24 Nov 2022
- [下载地址](https://www.php.net/distributions/php-8.1.13.tar.gz)
