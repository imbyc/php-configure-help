# 8.4.23 configure help info

```bash
'configure' configures PHP 8.4.23 to adapt to many kinds of systems.

Usage: src/8.4.23/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.23
- 时间：02 Jul 2026
- [下载地址](https://www.php.net/distributions/php-8.4.23.tar.gz)
