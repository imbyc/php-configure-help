# 8.0.17 configure help info

```bash
`configure' configures PHP 8.0.17 to adapt to many kinds of systems.

Usage: src/8.0.17/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.17
- 时间：17 Mar 2022
- [下载地址](https://www.php.net/distributions/php-8.0.17.tar.gz)
