# 8.2.20 configure help info

```bash
`configure' configures PHP 8.2.20 to adapt to many kinds of systems.

Usage: src/8.2.20/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.20
- 时间：06 Jun 2024
- [下载地址](https://www.php.net/distributions/php-8.2.20.tar.gz)
- sha256：05a4365f7bc6475ac4fef65dde13886913dbc0036e63895d369c1fc6e8206107
- md5：
