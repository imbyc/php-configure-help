# 8.1.0RC5 configure help info

```bash
`configure' configures PHP 8.1.0RC5 to adapt to many kinds of systems.

Usage: src/8.1.0RC5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0RC5
- 时间：28 Oct 2021
- [下载地址](https://downloads.php.net/~patrickallaert/php-8.1.0RC5.tar.gz)
- sha256：77f975a476dd9d28eb2543d8c0b47258e0e5a9cf5e2d2b843e7dcf04b6b405cb
- md5：
