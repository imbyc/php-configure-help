# 8.2.0RC2 configure help info

```bash
`configure' configures PHP 8.2.0RC2 to adapt to many kinds of systems.

Usage: src/8.2.0RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0RC2
- 时间：15 Sep 2022
- [下载地址](https://downloads.php.net/~sergey/php-8.2.0RC2.tar.gz)
- sha256：85ffc1628c660f6c494b90daf72bd656deaa362c2f02dae7ef9c1bb48addc55c
- md5：
