# 8.2.2 configure help info

```bash
`configure' configures PHP 8.2.2 to adapt to many kinds of systems.

Usage: src/8.2.2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.2
- 时间：02 Feb 2023
- [下载地址](https://www.php.net/distributions/php-8.2.2.tar.gz)
