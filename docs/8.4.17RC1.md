# 8.4.17RC1 configure help info

```bash
'configure' configures PHP 8.4.17RC1 to adapt to many kinds of systems.

Usage: src/8.4.17RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.17RC1
- 时间：01 Jan 2026
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.17RC1.tar.gz)
- sha256：a3062494dffd9be5be259eb20da6dc248954c5322b681b98b0a5cc93d125808d
- md5：
