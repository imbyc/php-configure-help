# 8.5.9RC1 configure help info

```bash
'configure' configures PHP 8.5.9RC1 to adapt to many kinds of systems.

Usage: src/8.5.9RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.9RC1
- 时间：16 July 2026
- [下载地址](https://downloads.php.net/~edorian/php-8.5.9RC1.tar.gz)
- sha256：eaeb7fc128cdce1ee4a16575f55e318a51554295b530dd914a03d08abc9023a3
- md5：
