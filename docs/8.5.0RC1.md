# 8.5.0RC1 configure help info

```bash
`configure' configures PHP 8.5.0RC1 to adapt to many kinds of systems.

Usage: src/8.5.0RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0RC1
- 时间：25 Sep 2025
- [下载地址](https://downloads.php.net/~daniels/php-8.5.0RC1.tar.gz)
