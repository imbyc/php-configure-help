# 8.2.21 configure help info

```bash
'configure' configures PHP 8.2.21 to adapt to many kinds of systems.

Usage: src/8.2.21/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.21
- 时间：04 Jul 2024
- [下载地址](https://www.php.net/distributions/php-8.2.21.tar.gz)
