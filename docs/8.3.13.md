# 8.3.13 configure help info

```bash
`configure' configures PHP 8.3.13 to adapt to many kinds of systems.

Usage: src/8.3.13/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.13
- 时间：24 Oct 2024
- [下载地址](https://www.php.net/distributions/php-8.3.13.tar.gz)
