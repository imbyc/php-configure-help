# 7.4.1 configure help info

```bash
`configure' configures PHP 7.4.1 to adapt to many kinds of systems.

Usage: src/7.4.1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.1
- 时间：18 Dec 2019
- [下载地址](https://www.php.net/distributions/php-7.4.1.tar.gz)
