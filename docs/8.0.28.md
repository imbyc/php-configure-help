# 8.0.28 configure help info

```bash
`configure' configures PHP 8.0.28 to adapt to many kinds of systems.

Usage: src/8.0.28/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.28
- 时间：14 Feb 2023
- [下载地址](https://www.php.net/distributions/php-8.0.28.tar.gz)
