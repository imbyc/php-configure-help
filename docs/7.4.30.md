# 7.4.30 configure help info

```bash
`configure' configures PHP 7.4.30 to adapt to many kinds of systems.

Usage: src/7.4.30/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.30
- 时间：09 Jun 2022
- [下载地址](https://www.php.net/distributions/php-7.4.30.tar.gz)
