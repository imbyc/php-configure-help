# 8.3.30 configure help info

```bash
'configure' configures PHP 8.3.30 to adapt to many kinds of systems.

Usage: src/8.3.30/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.30
- 时间：15 Jan 2026
- [下载地址](https://www.php.net/distributions/php-8.3.30.tar.gz)
