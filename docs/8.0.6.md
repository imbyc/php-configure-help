# 8.0.6 configure help info

```bash
`configure' configures PHP 8.0.6 to adapt to many kinds of systems.

Usage: src/8.0.6/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.6
- 时间：06 May 2021
- [下载地址](https://www.php.net/distributions/php-8.0.6.tar.gz)
