# 8.0.3 configure help info

```bash
`configure' configures PHP 8.0.3 to adapt to many kinds of systems.

Usage: src/8.0.3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.3
- 时间：04 Mar 2021
- [下载地址](https://www.php.net/distributions/php-8.0.3.tar.gz)
