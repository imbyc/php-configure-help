# 7.4.4 configure help info

```bash
`configure' configures PHP 7.4.4 to adapt to many kinds of systems.

Usage: src/7.4.4/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.4
- 时间：19 Mar 2020
- [下载地址](https://www.php.net/distributions/php-7.4.4.tar.gz)
