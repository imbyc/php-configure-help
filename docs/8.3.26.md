# 8.3.26 configure help info

```bash
'configure' configures PHP 8.3.26 to adapt to many kinds of systems.

Usage: src/8.3.26/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.26
- 时间：25 Sep 2025
- [下载地址](https://www.php.net/distributions/php-8.3.26.tar.gz)
