# 8.2.22 configure help info

```bash
`configure' configures PHP 8.2.22 to adapt to many kinds of systems.

Usage: src/8.2.22/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.22
- 时间：01 Aug 2024
- [下载地址](https://www.php.net/distributions/php-8.2.22.tar.gz)
- sha256：44197016c9eeed5c50523e20eb44adc4dd9d84ac08bdf9e46077e775d467d7d0
- md5：
