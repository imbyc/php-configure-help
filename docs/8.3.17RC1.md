# 8.3.17RC1 configure help info

```bash
'configure' configures PHP 8.3.17RC1 to adapt to many kinds of systems.

Usage: src/8.3.17RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.17RC1
- 时间：30 Jan 2025
- [下载地址](https://downloads.php.net/~jakub/php-8.3.17RC1.tar.gz)
- sha256：70757ee9c6b0d5525075b3a5352962bf47ba50b31109c5b77cfd24d719f41270
- md5：
