# 8.5.0alpha2 configure help info

```bash
`configure' configures PHP 8.5.0alpha2 to adapt to many kinds of systems.

Usage: src/8.5.0alpha2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0alpha2
- 时间：17 Jul 2025
- [下载地址](https://downloads.php.net/~edorian/php-8.5.0alpha2.tar.gz)
- sha256：60868a9cb73726c247226b048bfa3727a4a6a72ced283e5351e16d84abf9398e
- md5：
