# 8.0.30 configure help info

```bash
`configure' configures PHP 8.0.30 to adapt to many kinds of systems.

Usage: src/8.0.30/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.30
- 时间：03 Aug 2023
- [下载地址](https://www.php.net/distributions/php-8.0.30.tar.gz)
