# 7.4.24 configure help info

```bash
`configure' configures PHP 7.4.24 to adapt to many kinds of systems.

Usage: src/7.4.24/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.24
- 时间：23 Sep 2021
- [下载地址](https://www.php.net/distributions/php-7.4.24.tar.gz)
