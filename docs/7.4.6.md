# 7.4.6 configure help info

```bash
`configure' configures PHP 7.4.6 to adapt to many kinds of systems.

Usage: src/7.4.6/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.6
- 时间：14 May 2020
- [下载地址](https://www.php.net/distributions/php-7.4.6.tar.gz)
