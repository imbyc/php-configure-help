# 8.4.25RC1 configure help info

```bash
'configure' configures PHP 8.4.25RC1 to adapt to many kinds of systems.

Usage: src/8.4.25RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.25RC1
- 时间：13 August 2026
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.25RC1.tar.gz)
- sha256：0d1b8936e67bae406f20691a4225b398baaa31a1dbdeea5959a553a26c9f5f86
- md5：
