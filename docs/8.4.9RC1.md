# 8.4.9RC1 configure help info

```bash
'configure' configures PHP 8.4.9RC1 to adapt to many kinds of systems.

Usage: src/8.4.9RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.9RC1
- 时间：19 Jun 2025
- [下载地址](https://downloads.php.net/~saki/php-8.4.9RC1.tar.gz)
- sha256：68cc7a69841d5ed09886d6be686de55ca09859c0fb8f033fbcec744d13e44dba
- md5：
