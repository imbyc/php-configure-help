# 8.1.12RC1 configure help info

```bash
`configure' configures PHP 8.1.12RC1 to adapt to many kinds of systems.

Usage: src/8.1.12RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.12RC1
- 时间：13 Oct 2022
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.12RC1.tar.gz)
- sha256：22302cebfe679c16631dae219b135813041aeda2942f549efa1d1cc014801c44
- md5：
