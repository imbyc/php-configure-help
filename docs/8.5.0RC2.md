# 8.5.0RC2 configure help info

```bash
'configure' configures PHP 8.5.0RC2 to adapt to many kinds of systems.

Usage: src/8.5.0RC2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.5.0RC2
- 时间：09 Oct 2025
- [下载地址](https://downloads.php.net/~edorian/php-8.5.0RC2.tar.gz)
- sha256：9ba719c814e0e84575aece7c9011dfa2f05479413b3007955dafa1b2537700fc
- md5：
