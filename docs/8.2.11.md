# 8.2.11 configure help info

```bash
`configure' configures PHP 8.2.11 to adapt to many kinds of systems.

Usage: src/8.2.11/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.11
- 时间：28 Sep 2023
- [下载地址](https://www.php.net/distributions/php-8.2.11.tar.gz)
