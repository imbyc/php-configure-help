# 8.2.0RC5 configure help info

```bash
`configure' configures PHP 8.2.0RC5 to adapt to many kinds of systems.

Usage: src/8.2.0RC5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.0RC5
- 时间：27 Oct 2022
- [下载地址](https://downloads.php.net/~pierrick/php-8.2.0RC5.tar.gz)
- sha256：c879b316d6f9c06ae6c6d7a418d94ddd569f32ab06c13d6d8ffc88643a0692ec
- md5：
