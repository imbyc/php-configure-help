# 8.1.5 configure help info

```bash
`configure' configures PHP 8.1.5 to adapt to many kinds of systems.

Usage: src/8.1.5/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.5
- 时间：14 Apr 2022
- [下载地址](https://www.php.net/distributions/php-8.1.5.tar.gz)
