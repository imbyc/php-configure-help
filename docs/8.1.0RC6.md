# 8.1.0RC6 configure help info

```bash
`configure' configures PHP 8.1.0RC6 to adapt to many kinds of systems.

Usage: src/8.1.0RC6/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0RC6
- 时间：11 Nov 2021
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.0RC6.tar.gz)
- sha256：cae225663e5130aa75d81d9dcd75c0fcdb95ebbf82ef2b9fc94575684c4a22fe
- md5：
