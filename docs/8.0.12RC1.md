# 8.0.12RC1 configure help info

```bash
`configure' configures PHP 8.0.12RC1 to adapt to many kinds of systems.

Usage: src/8.0.12RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.12RC1
- 时间：07 Oct 2021
- [下载地址](https://downloads.php.net/~krakjoe/php-8.0.12RC1.tar.gz)
- sha256：6cbb9cdc0371ea0883acc75efbcb579c304afacd57c197e624efc187e3f7da6a
- md5：
