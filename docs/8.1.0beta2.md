# 8.1.0beta2 configure help info

```bash
`configure' configures PHP 8.1.0beta2 to adapt to many kinds of systems.

Usage: src/8.1.0beta2/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0beta2
- 时间：5 Aug 2021
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.0beta2.tar.gz)
- sha256：fa01ebf8e1d06fdef0eb0cd41093f1c27d8fd10073c00aa1c36c88bcde67d9c7
- md5：
