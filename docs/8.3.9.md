# 8.3.9 configure help info

```bash
`configure' configures PHP 8.3.9 to adapt to many kinds of systems.

Usage: src/8.3.9/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.9
- 时间：04 Jul 2024
- [下载地址](https://www.php.net/distributions/php-8.3.9.tar.gz)
