# 8.1.14RC1 configure help info

```bash
`configure' configures PHP 8.1.14RC1 to adapt to many kinds of systems.

Usage: src/8.1.14RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.14RC1
- 时间：15 Dec 2022
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.14RC1.tar.gz)
- sha256：6a0bba5351606a017a492bc1fd4188ce74b535d866a219996e8575bff9d5209e
- md5：
