# 7.4.20RC1 configure help info

```bash
`configure' configures PHP 7.4.20RC1 to adapt to many kinds of systems.

Usage: src/7.4.20RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：7.4.20RC1
- 时间：20 May 2021
- [下载地址](https://downloads.php.net/~derick/php-7.4.20RC1.tar.gz)
- sha256：0cce2a96e8cb80d0164c4db7117213c8f2c0abb50e3f5d89ac70b404a99749fd
- md5：
