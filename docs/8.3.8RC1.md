# 8.3.8RC1 configure help info

```bash
`configure' configures PHP 8.3.8RC1 to adapt to many kinds of systems.

Usage: src/8.3.8RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.8RC1
- 时间：23 May 2024
- [下载地址](https://downloads.php.net/~eric/php-8.3.8RC1.tar.gz)
- sha256：42f5977396141dcf117b59889c06b843b88e6171f938bf2eeaded3e1cdd6180c
- md5：
