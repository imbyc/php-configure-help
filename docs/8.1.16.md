# 8.1.16 configure help info

```bash
`configure' configures PHP 8.1.16 to adapt to many kinds of systems.

Usage: src/8.1.16/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.16
- 时间：14 Feb 2023
- [下载地址](https://www.php.net/distributions/php-8.1.16.tar.gz)
