# 8.0.29 configure help info

```bash
`configure' configures PHP 8.0.29 to adapt to many kinds of systems.

Usage: src/8.0.29/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.29
- 时间：08 Jun 2023
- [下载地址](https://www.php.net/distributions/php-8.0.29.tar.gz)
