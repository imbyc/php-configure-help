# 8.3.6 configure help info

```bash
`configure' configures PHP 8.3.6 to adapt to many kinds of systems.

Usage: src/8.3.6/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.6
- 时间：11 Apr 2024
- [下载地址](https://www.php.net/distributions/php-8.3.6.tar.gz)
