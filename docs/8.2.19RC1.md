# 8.2.19RC1 configure help info

```bash
'configure' configures PHP 8.2.19RC1 to adapt to many kinds of systems.

Usage: src/8.2.19RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.19RC1
- 时间：25 Apr 2024
- [下载地址](https://downloads.php.net/~sergey/php-8.2.19RC1.tar.gz)
- sha256：cb12af57594b2be67b16cba58cb89142be3c5afe02747985d08255b863152f6c
- md5：
