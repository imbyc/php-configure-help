# 8.3.20RC1 configure help info

```bash
'configure' configures PHP 8.3.20RC1 to adapt to many kinds of systems.

Usage: src/8.3.20RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.3.20RC1
- 时间：27 Mar 2025
- [下载地址](https://downloads.php.net/~jakub/php-8.3.20RC1.tar.gz)
- sha256：d9e0f102cb4c0d5ae4e289743d9699c96bfe17e97ac2aa903cce43d5f81f6048
- md5：
