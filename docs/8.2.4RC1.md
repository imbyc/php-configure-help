# 8.2.4RC1 configure help info

```bash
`configure' configures PHP 8.2.4RC1 to adapt to many kinds of systems.

Usage: src/8.2.4RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.2.4RC1
- 时间：02 Mar 2023
- [下载地址](https://downloads.php.net/~sergey/php-8.2.4RC1.tar.gz)
- sha256：1fcaa7b9e279ba15c32670eaab47e27b81d0c798539f83e0120ebf7a552a691a
- md5：
