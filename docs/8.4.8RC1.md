# 8.4.8RC1 configure help info

```bash
'configure' configures PHP 8.4.8RC1 to adapt to many kinds of systems.

Usage: src/8.4.8RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.4.8RC1
- 时间：22 May 2025
- [下载地址](https://downloads.php.net/~calvinb/php-8.4.8RC1.tar.gz)
- sha256：37597255d048e00632d0d4a53c97157fa1fa25068cad9c57de6e0d0548193bd7
- md5：
