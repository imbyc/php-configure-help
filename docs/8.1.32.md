# 8.1.32 configure help info

```bash
'configure' configures PHP 8.1.32 to adapt to many kinds of systems.

Usage: src/8.1.32/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.32
- 时间：13 Mar 2025
- [下载地址](https://www.php.net/distributions/php-8.1.32.tar.gz)
