# 8.1.0alpha3 configure help info

```bash
`configure' configures PHP 8.1.0alpha3 to adapt to many kinds of systems.

Usage: src/8.1.0alpha3/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.0alpha3
- 时间：8 Jul 2021
- [下载地址](https://downloads.php.net/~ramsey/php-8.1.0alpha3.tar.gz)
- sha256：0a28c8923baf4d57a8f1b03b8bc8fe51225632cf9e0b6622470e2938965f4874
- md5：
