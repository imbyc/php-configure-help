# 8.0.4RC1 configure help info

```bash
`configure' configures PHP 8.0.4RC1 to adapt to many kinds of systems.

Usage: src/8.0.4RC1/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.0.4RC1
- 时间：18 Mar 2021
- [下载地址](https://downloads.php.net/~carusogabriel/php-8.0.4RC1.tar.gz)
- sha256：30562034a57a9c347b103fbf1617fc2d3fc4f1bd197e84e1827239524883b5d3
- md5：
