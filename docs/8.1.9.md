# 8.1.9 configure help info

```bash
`configure' configures PHP 8.1.9 to adapt to many kinds of systems.

Usage: src/8.1.9/configure [OPTION]... [VAR=VALUE]...
...
- 版本：8.1.9
- 时间：04 Aug 2022
- [下载地址](https://www.php.net/distributions/php-8.1.9.tar.gz)
